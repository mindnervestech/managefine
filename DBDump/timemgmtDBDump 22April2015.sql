...
-- Dumping database structure for timemgmt22
CREATE DATABASE IF NOT EXISTS `timemgmt22` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `timemgmt22`;


-- Dumping structure for table timemgmt22.apply_leave
...
-- Dumping structure for table timemgmt22.case_data
...
-- Dumping data for table timemgmt22.case_data: ~12 rows (approximately)
/*!40000 ALTER TABLE `case_data` DISABLE KEYS */;
INSERT INTO `case_data` (`id`, `title`, `description`, `status`, `notes`, `projects_id`, `assignto_id`, `userid`, `type`, `due_date`, `company_id`) VALUES
	(1, 'dfsvcds', 'sdcsd', 'Approved', 'sdcsdc', 3, 8, NULL, NULL, '2015-04-01 00:00:00', 2),
	(2, 'wed', 'wed', 'Disapproved', 'sdcsd', 3, 7, NULL, NULL, NULL, 2),
	(3, 'sdfcdsc', 'sdfcdsc', 'Disapproved', '{"currentuser":"4","notedate":"Mon Apr 13 15:01:32 IST 2015","note":"sdcsdc"}', 3, 5, NULL, NULL, '2015-04-28 00:00:00', 1),
	(4, 'NEWW', 'erfer', 'Approved', 'efvcefc', 3, 7, NULL, NULL, '2015-04-29 00:00:00', 2),
	(5, 'AAASSSS', 'wdwexc', 'Disapproved', 'ED', 3, 7, NULL, NULL, '2015-04-16 00:00:00', 2),
	(12, 'sdcsd', 'sdcsd', 'Assigned', ' \r\n		ASASASASASASASA					', 3, 4, NULL, NULL, '2015-04-28 00:00:00', 1),
	(13, 'EFWD', 'ewfwed', 'PendingApproval', '{"currentuser":"4","notedate":"Mon Apr 13 17:17:54 IST 2015","note":"wefwe"}', 3, 8, NULL, NULL, '2015-04-23 00:00:00', 2),
	(14, 'SDSC', 'wdwe', 'Approved', 'dscsc', 3, 7, NULL, NULL, '2015-04-16 00:00:00', 2),
	(15, 'SDSC', 'wdwe', 'Approved', 'dscsc', 3, 7, NULL, NULL, '2015-04-16 00:00:00', NULL),
	(16, 'OO2', 'dsada', 'Approved', 'KKKKK', 3, 5, NULL, NULL, '2015-04-06 00:00:00', 2),
	(17, 'NEW Task', 'ALLL', 'Approved', 'New Note', 1, 7, NULL, NULL, '2015-04-22 00:00:00', 2),
	(18, 'efve', 'efvrf', 'Unassigned', ' jhjhhjkljkljkljjkljlkj\r\n							', 1, 4, NULL, 'Tasks', '2015-04-16 00:00:00', 2);
/*!40000 ALTER TABLE `case_data` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.case_flexi
CREATE TABLE IF NOT EXISTS `case_flexi` (
  `case_data_id` bigint(20) NOT NULL,
  `flexi_id` bigint(20) NOT NULL,
  `value` varchar(1255) NOT NULL,
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  KEY `caseflexi` (`case_data_id`),
  KEY `caseflexi2` (`flexi_id`),
  CONSTRAINT `caseflexi` FOREIGN KEY (`case_data_id`) REFERENCES `case_data` (`id`),
  CONSTRAINT `caseflexi2` FOREIGN KEY (`flexi_id`) REFERENCES `flexi_attribute` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt22.case_flexi: ~9 rows (approximately)
/*!40000 ALTER TABLE `case_flexi` DISABLE KEYS */;
INSERT INTO `case_flexi` (`case_data_id`, `flexi_id`, `value`, `id`) VALUES
...
-- Dumping structure for table timemgmt22.case_notes
...
-- Dumping data for table timemgmt22.case_notes: ~6 rows (approximately)
...
INSERT INTO `case_notes` (`id`, `casedata_id`, `casenote`, `note_user`, `note_date`) VALUES
	...
	(4, 17, 'New Note', 4, '2015-04-14 15:31:42'),
	(5, 16, 'KKKKK', 4, '2015-04-14 15:33:09'),
	(6, 18, 'efr', 4, '2015-04-14 20:11:29');
/*!40000 ALTER TABLE `case_notes` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.client
...
-- Dumping data for table timemgmt22.client: ~0 rows (approximately)
...
-- Dumping structure for table timemgmt22.client_flexi
...
-- Dumping data for table timemgmt22.client_flexi: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.company
...
-- Dumping data for table timemgmt22.company: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.delegate
...
-- Dumping data for table timemgmt22.delegate: ~0 rows (approximately)
/*!40000 ALTER TABLE `delegate` DISABLE KEYS */;
/*!40000 ALTER TABLE `delegate` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.department
...
-- Dumping data for table timemgmt22.department: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.feedback
...
-- Dumping data for table timemgmt22.feedback: ~0 rows (approximately)
/*!40000 ALTER TABLE `feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.flexi_attribute
...
-- Dumping data for table timemgmt22.flexi_attribute: ~19 rows (approximately)
...
INSERT INTO `flexi_attribute` (`id`, `model`, `type`, `name`, `uniqueid`) VALUES
	...
	(17, 'models.SupplierFlexi', 'string', 'Add', 5),
	(18, 'models.SupplierFlexi', 'string', 'Add', 5),
	(19, 'models.SupplierFlexi', 'string', 'asx', 5),
	(20, 'models.SupplierFlexi', 'string', 'Addd', 5),
	(21, 'models.SupplierFlexi', 'string', 'WWW', 5),
	(22, 'models.caseFlexi', 'FILE', 'Attachment', 6);
/*!40000 ALTER TABLE `flexi_attribute` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.leaves_credit
...
-- Dumping data for table timemgmt22.leaves_credit: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.leave_balance
...
-- Dumping data for table timemgmt22.leave_balance: ~9 rows (approximately)
...
-- Dumping structure for table timemgmt22.leave_level
...
-- Dumping data for table timemgmt22.leave_level: ~2 rows (approximately)
...
INSERT INTO `leave_level` (`id`, `leave_type`, `carry_forward`, `leave_x_id`, `role_leave_id`, `last_update`) VALUES
	...
	(2, 'Vacation', 'NO', 2, NULL, '2015-04-14 16:04:59');
/*!40000 ALTER TABLE `leave_level` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.leave_x
...
-- Dumping data for table timemgmt22.leave_x: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.mail_setting
...
-- Dumping data for table timemgmt22.mail_setting: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.notification
...
-- Dumping data for table timemgmt22.notification: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.organization
...
-- Dumping data for table timemgmt22.organization: ~16 rows (approximately)
...
-- Dumping structure for table timemgmt22.project
...
-- Dumping data for table timemgmt22.project: ~2 rows (approximately)
...
INSERT INTO `project` (`id`, `client_name_id`, `project_name`, `project_code`, `project_description`, `start_date`, `end_date`, `budget`, `currency`, `efforts`, `project_manager_id`, `company_obj_id`) VALUES
	(1, 1, 'Aptitude Test 2', 'AT-2', 'exam 2', '2014-01-20 00:00:00', '2014-02-10 00:00:00', 123456, 'INR', 2, 5, 2),
	(2, 1, 'hkj', '1', 'Test', '2014-02-04 00:00:00', '2014-02-27 00:00:00', 568, 'INR', 769, 7, 1);
/*!40000 ALTER TABLE `project` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.projectclass
...
-- Dumping data for table timemgmt22.projectclass: ~10 rows (approximately)
...
INSERT INTO `projectclass` (`id`, `project_types`, `project_description`) VALUES
	...
	(14, 'ProjectType Test1', 'This is test project type');
/*!40000 ALTER TABLE `projectclass` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.projectclassnode
...
-- Dumping data for table timemgmt22.projectclassnode: ~49 rows (approximately)
...
-- Dumping structure for table timemgmt22.projectclassnodeattribut
...
-- Dumping data for table timemgmt22.projectclassnodeattribut: ~55 rows (approximately)
...
INSERT INTO `projectclassnodeattribut` (`id`, `name`, `type`, `value`, `projectnode_id`) VALUES
	...
	(120, 'Name', 'String', NULL, 78),
	(121, 'Age', 'Integer', NULL, 78),
	(122, 'Name', 'String', NULL, 79),
	(123, 'DOB', 'Date', NULL, 79);
/*!40000 ALTER TABLE `projectclassnodeattribut` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.projectinstance
...
-- Dumping data for table timemgmt22.projectinstance: ~38 rows (approximately)
/*!40000 ALTER TABLE `projectinstance` DISABLE KEYS */;
INSERT INTO `projectinstance` (`id`, `project_name`, `project_description`, `projectid`, `client_id`, `client_name`, `start_date`, `end_date`, `userid_id`) VALUES
	(1, 'maruti', 'ww ww', 11, 1, 'abcd', '02-02-2016', '04-04-2016', NULL),
	(2, 'swift', 'ttt yyyy', 11, 1, 'abcd', '2015-02-03', '2015-06-10', NULL),
	(23, 'farrari', 'rr rrr', 11, 1, 'abcd', '02-04-2015', '23-04-2015', NULL),
	(27, 'yogesh', 'fff ggg g g g g g g g g g  g g g g g', 6, 1, 'abcd', NULL, NULL, NULL),
	(36, 'Client', 'Client in India', 13, 1, 'abcd', NULL, NULL, NULL),
	(37, 'sdfs', 'sdf', 6, 1, 'abcd', NULL, NULL, NULL),
	(47, 'MyCar', 'car', 11, 2, 'Yogesh', NULL, NULL, NULL),
	(49, 'aksha', 'sapanch', 11, 2, 'Yogesh', NULL, NULL, NULL),
	(50, 'tata', 'ffrfrff', 6, 2, 'Yogesh', NULL, NULL, NULL),
	(51, 'dfgffggggg', 'dfgdf', 7, 2, 'Yogesh', NULL, NULL, NULL),
	(52, 'dddd', 'fr frfrf', 7, 1, 'abcd', NULL, NULL, NULL),
	(53, 'hh66', 'fg hh', 8, 1, 'abcd', NULL, NULL, NULL),
	(54, 'ert', 'ert', 7, 1, 'abcd', NULL, NULL, NULL),
	(55, 'sss', 'ddd', 6, 1, 'abcd', NULL, NULL, NULL),
	(56, 'dsfsd', 'sdf', 7, 2, 'Yogesh', NULL, NULL, NULL),
	(57, 'farrari', 'jijij', 6, 1, 'abcd', NULL, NULL, NULL),
	(58, 'asdsa0000', 'dd tt 666', 7, 1, 'abcd', NULL, NULL, NULL),
	(59, 'er231422', 'ff ggg5555', 6, 1, 'abcd', NULL, NULL, 2),
	(60, '666 555', 'fff', 11, 2, 'Yogesh', NULL, NULL, 3),
	(61, 'ttt6664422', 'aa', 7, 1, 'abcd', NULL, NULL, 5),
	(62, 'ttt6664422', 'aa', 7, 1, 'abcd', NULL, NULL, 5),
	(63, 'ttt6664422', 'aa', 7, 1, 'abcd', NULL, NULL, 5),
	(64, 'ttt6664422', 'aa', 7, 1, 'abcd', NULL, NULL, 5),
	(65, 'ggg', 'dd', 7, 1, 'abcd', NULL, NULL, 2),
	(66, 'sdsdf', 'sdf', 8, 1, 'abcd', NULL, NULL, 1),
	(67, 'sdsdf', 'sdf', 8, 1, 'abcd', NULL, NULL, 1),
	(68, 'sdsdf', 'sdf', 8, 1, 'abcd', NULL, NULL, 1),
	(69, 'dd', 'hsd sd', 8, 1, 'abcd', NULL, NULL, 1),
	(70, 'dd', 'hsd sd', 8, 1, 'abcd', NULL, NULL, 1),
	(71, 'dd', 'hsd sd', 8, 1, 'abcd', NULL, NULL, 1),
	(72, 'dd', 'hsd sd', 8, 1, 'abcd', NULL, NULL, 1),
	(73, 'dd', 'hsd sd', 8, 1, 'abcd', NULL, NULL, 1),
	(74, 'dd', 'hsd sd', 8, 1, 'abcd', '03-04-2015', '06-04-2015', 1),
	(75, 'dd', 'hsd sd', 8, 1, 'abcd', '02-03-2015', '04-04-2015', 1),
	(76, 'dd', 'hsd sd', 8, 1, 'abcd', NULL, NULL, 1),
	(77, 'weeer', 'ffrfrf', 10, 1, 'abcd', '02-04-2015', '03-04-2015', 2),
	(78, 'sdsd', 'sdf', 9, 1, 'abcd', '04-04-2015', '06-05-2015', 2),
	(79, 'sdsd', 'sdf', 9, 1, 'abcd', NULL, NULL, 2);
/*!40000 ALTER TABLE `projectinstance` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.projectinstancenode
...
-- Dumping data for table timemgmt22.projectinstancenode: ~12 rows (approximately)
/*!40000 ALTER TABLE `projectinstancenode` DISABLE KEYS */;
INSERT INTO `projectinstancenode` (`id`, `Projectclassnode_id`, `projecttypeid`, `projectinstanceid`, `start_date`, `end_date`, `task_compilation`, `weightage`, `project_manager`, `supplier_id`, `user_id`, `status`) VALUES
	(31, 83, 16, 41, '0006-07-08', '0035-07-08', 0, 2, NULL, NULL, NULL, NULL),
	(32, 83, 16, 42, '2016-01-01', '2016-01-30', 0, 4, NULL, NULL, NULL, NULL),
	(40, 2, 6, 46, '2015-04-02', '2015-04-25', 0, 3, NULL, NULL, NULL, NULL),
	(41, 67, 11, 23, '2015-04-02', '2015-04-23', 62, 2, NULL, NULL, NULL, 'Inprogress'),
	(42, 68, 11, 23, '2015-04-13', '2015-04-24', 70, 3, NULL, NULL, NULL, 'Inprogress'),
	(43, 69, 11, 23, '2015-04-14', '2015-04-25', 50, 4, NULL, NULL, NULL, NULL),
	(44, 70, 11, 23, '2015-04-16', '2015-04-27', 67, 5, NULL, NULL, NULL, NULL),
	(45, 76, 11, 23, '2015-04-15', '2015-04-22', 70, 2, NULL, NULL, NULL, 'Inprogress'),
	(46, 19, 8, 75, '2015-03-02', '2015-04-04', 0, 3, NULL, 2, 2, NULL),
	(47, 20, 8, 76, '2015-03-03', '2015-04-04', 0, 3, NULL, 2, 2, NULL),
	(48, 62, 10, 77, '2015-04-02', '2015-04-03', 0, 2, NULL, 2, 3, NULL),
	(49, 58, 9, 78, '2015-04-04', '2015-05-06', 0, 3, NULL, 1, 1, NULL);
/*!40000 ALTER TABLE `projectinstancenode` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.projectinstance_supplier
CREATE TABLE IF NOT EXISTS `projectinstance_supplier` (
  `projectinstance_id` bigint(20) NOT NULL,
  `supplier_id` bigint(20) NOT NULL,
  KEY `FK_projectinstance_supplier_projectinstance` (`projectinstance_id`),
  KEY `FK_projectinstance_supplier_supplier` (`supplier_id`),
  CONSTRAINT `FK_projectinstance_supplier_projectinstance` FOREIGN KEY (`projectinstance_id`) REFERENCES `projectinstance` (`id`),
  CONSTRAINT `FK_projectinstance_supplier_supplier` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table timemgmt22.projectinstance_supplier: ~32 rows (approximately)
...
-- Dumping structure for table timemgmt22.projectinstance_user
...
-- Dumping data for table timemgmt22.projectinstance_user: ~31 rows (approximately)
...
-- Dumping structure for table timemgmt22.project_attachment
...
-- Dumping data for table timemgmt22.project_attachment: ~5 rows (approximately)
...
-- Dumping structure for table timemgmt22.project_comment
...
-- Dumping data for table timemgmt22.project_comment: ~4 rows (approximately)
...
-- Dumping structure for table timemgmt22.project_flexi
...
-- Dumping data for table timemgmt22.project_flexi: ~0 rows (approximately)
/*!40000 ALTER TABLE `project_flexi` DISABLE KEYS */;
/*!40000 ALTER TABLE `project_flexi` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.project_task
...
-- Dumping data for table timemgmt22.project_task: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.project_user
...
-- Dumping data for table timemgmt22.project_user: ~6 rows (approximately)
...
-- Dumping structure for table timemgmt22.role
CREATE TABLE IF NOT EXISTS `role` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_role_company` (`role_x_id`),
  CONSTRAINT `FK_role_role_x` FOREIGN KEY (`role_x_id`) REFERENCES `role_x` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt22.role: ~14 rows (approximately)
/*!40000 ALTER TABLE `role` DISABLE KEYS */;
INSERT INTO `role` (`id`, `role_name`, `role_description`, `parent_id`, `role_x_id`) VALUES
	(1, 'Subject Mater Expert', 'rootDescription', NULL, 1),
	(10, 'Senior Subject Mater Expert', '96667777777777', '1', 1),
	(11, 'Team Lead', 'fgff', '1', 1),
	(13, 'Expert', '888', '10', 1),
	(14, 'Project Manager', 'yyyy', '10', 1),
	(15, 'Senior Expert', 'SANGU SANGU1', '11', 1),
	(16, 'Director', 'Director', '13', 1),
	(17, 'CEO', 'CEO', '11', 1),
	(18, 'OWNER', 'OWNER', '1', 1),
	(19, 'Co-Owner', 'Co-Owner', '14', 2),
	(20, 'Software Engineer', 'Software Engineer', '15', 2),
	(21, 'Senior Software Engineer', 'Senior Software Engineer', '16', 2),
	(22, 'Group Lead', 'Group Lead', '14', 2),
	(23, 'Project Manager', 'PRO', '17', 2);
/*!40000 ALTER TABLE `role` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.role_leave
CREATE TABLE IF NOT EXISTS `role_leave` (
  ...
  CONSTRAINT `FK_role_leave_role` FOREIGN KEY (`role_level_id`) REFERENCES `role` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt22.role_leave: ~26 rows (approximately)
...
-- Dumping structure for table timemgmt22.role_level
...
-- Dumping data for table timemgmt22.role_level: ~14 rows (approximately)
...
-- Dumping structure for table timemgmt22.role_x
...
-- Dumping data for table timemgmt22.role_x: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.saveattributes
...
-- Dumping data for table timemgmt22.saveattributes: ~22 rows (approximately)
...
INSERT INTO `saveattributes` (`id`, `attribut_value`, `projectattrid`, `projectinstancenode_id`, `attribut_name`, `type`) VALUES
	(33, 'TCS', 118, 30, NULL, NULL),
	(34, 'Swapnil', 138, 33, NULL, NULL),
	(35, '741852960', 139, 33, NULL, NULL),
	(36, '1994-05-12', 140, 33, NULL, NULL),
	(37, 'Male', 141, 33, NULL, NULL),
	(38, 'qwertyu@qwer.com', 142, 33, NULL, NULL),
	(39, 'Sumit', 136, 35, NULL, NULL),
	(40, '74852960', 137, 35, NULL, NULL),
	(41, 'Sam', 143, 36, NULL, NULL),
	(42, '74185260', 144, 36, NULL, NULL),
	(43, 'wsd', 145, 37, NULL, NULL),
	(44, '784565435', 146, 37, NULL, NULL),
	(45, 'manish', 181, 38, NULL, NULL),
	(46, '741852960', 182, 38, NULL, NULL),
	(47, 'Krishna', 177, 39, NULL, NULL),
	(48, '741852960', 180, 39, NULL, NULL),
	(49, 'MRF', 116, 42, NULL, NULL),
	(50, 'Honda,', 117, 42, NULL, NULL),
	(51, 'MNT', 118, 42, NULL, NULL),
	(52, 'Pop', 99, 43, NULL, NULL),
	(53, 'rock', 100, 44, NULL, NULL),
	(54, 'asa', 119, 45, NULL, NULL);
/*!40000 ALTER TABLE `saveattributes` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.supplier
...
-- Dumping data for table timemgmt22.supplier: ~2 rows (approximately)
...
INSERT INTO `supplier` (`id`, `supplier_name`, `phone_no`, `email`, `password`, `fax`, `address`, `street`, `city`, `country`, `pin`, `contact_name`, `contact_phone`, `contact_email`, `company_id`) VALUES
	(1, 'kkkk', '98909', 'jhjhj@uyt.com', '222', 99, 'kjjkj', 'kjnj', 'kjnkj', 'kjloiiu', '7788', 'yyyyy', '00000', 'vgvg@gfv.com', 2),
	(2, 'SSS1', '2222', 'asx@ead.com', '444', 0, 'wef', '', 'sdfs', 'sdvcsdv', '234234', 'sdfsdv', '2312', 'adswqd@ewadws.cdswc', 2);
/*!40000 ALTER TABLE `supplier` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.supplier_flexi
...
-- Dumping data for table timemgmt22.supplier_flexi: ~5 rows (approximately)
/*!40000 ALTER TABLE `supplier_flexi` DISABLE KEYS */;
INSERT INTO `supplier_flexi` (`supplier_id`, `flexi_id`, `value`, `id`) VALUES
	(2, 17, 'edfs', 1),
	(2, 18, 'sdfsd', 2),
	(2, 19, 'sdcs', 3),
	(2, 20, 'sdcsd', 4),
...
-- Dumping structure for table timemgmt22.task
...
-- Dumping data for table timemgmt22.task: ~2 rows (approximately)
...
-- Dumping structure for table timemgmt22.task_flexi
...
-- Dumping data for table timemgmt22.task_flexi: ~0 rows (approximately)
/*!40000 ALTER TABLE `task_flexi` DISABLE KEYS */;
/*!40000 ALTER TABLE `task_flexi` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.task_project
...
-- Dumping data for table timemgmt22.task_project: ~3 rows (approximately)
...
-- Dumping structure for table timemgmt22.timesheet
...
-- Dumping data for table timemgmt22.timesheet: ~11 rows (approximately)
...
-- Dumping structure for table timemgmt22.timesheet_actual
...
-- Dumping data for table timemgmt22.timesheet_actual: ~4 rows (approximately)
...
-- Dumping structure for table timemgmt22.timesheet_days
...
-- Dumping data for table timemgmt22.timesheet_days: ~63 rows (approximately)
...
INSERT INTO `timesheet_days` (`id`, `day`, `timesheet_date`, `time_from`, `time_to`, `work_minutes`, `timesheet_row_id`) VALUES
	...
	(137, 'thursday', '2015-04-16', '13:00', '14:00', 60, 35),
...
-- Dumping structure for table timemgmt22.timesheet_days_actual
...
-- Dumping data for table timemgmt22.timesheet_days_actual: ~49 rows (approximately)
...
-- Dumping structure for table timemgmt22.timesheet_row
...
-- Dumping data for table timemgmt22.timesheet_row: ~13 rows (approximately)
...
-- Dumping structure for table timemgmt22.timesheet_row_actual
...
-- Dumping data for table timemgmt22.timesheet_row_actual: ~7 rows (approximately)
...
-- Dumping structure for table timemgmt22.user
...
-- Dumping data for table timemgmt22.user: ~7 rows (approximately)
...
INSERT INTO `user` (`id`, `salutation`, `employee_id`, `first_name`, `middle_name`, `last_name`, `email`, `gender`, `status`, `hire_date`, `annual_income`, `hourlyrate`, `companyobject_id`, `designation`, `role_id`, `level_id`, `manager_id`, `release_date`, `hrmanager_id`, `permissions`, `temp_password`, `password`, `reset_flag`, `failed_login_attempt`, `create_date`, `modified_date`, `password_reset`, `user_status`, `process_instance_id`, `last_update`, `department`) VALUES
	...
	(3, 'Mr', '1', 'Project', '', 'Manager', 'pm@ggg.com', 'Male', 'OnRolls', '2015-02-23 00:00:00', 1000000, 480.77, 2, 'Project Manager', 20, NULL, 2, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|UserRequest|MyBucket|GanttView|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-20 12:40:03', NULL),
	...
	(7, 'Miss', 'W1', 'WWW3', '', 'KKKK', 'werwer@wew.com@ggg.com', 'Male', 'OnRolls', '2015-04-15 00:00:00', 32423, 15.59, 2, 'Software Engineer', 17, NULL, 2, NULL, NULL, 'UserRequest|ManageClient|Mail|ManageProject|FeedBackCreate|OrgHierarchy|ManageUser|MyBucket|ManageTask|UserPermissions|LeaveBucket|DefineRoles|RolePermissions|Notification|Delegate|TeamRate|FeedBackView|Home|ProjectReport|', 1, 'nqzsau', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-14 15:22:39', 'cool');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;


-- Dumping structure for table timemgmt22.user_flexi
...
-- Dumping data for table timemgmt22.user_flexi: ~46 rows (approximately)
...
-- Dumping structure for table timemgmt22.user_leave
...
-- Dumping data for table timemgmt22.user_leave: ~3 rows (approximately)
...
-- Dumping structure for table timemgmt22.user_project
...
-- Dumping data for table timemgmt22.user_project: ~0 rows (approximately)
