...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  KEY `ix_client_user_10` (`user_id`),
  CONSTRAINT `fk_client_user_10` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_client_company_8` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.client: ~3 rows (approximately)
...
INSERT INTO `client` (`id`, `client_name`, `phone_no`, `email`, `fax`, `address`, `street`, `city`, `country`, `pin`, `contact_name`, `contact_phone`, `contact_email`, `company_id`, `user_id`) VALUES
	(1, 'Roque', '3228022291', 'roque.almedia@gmail.com', NULL, 'Putio Vittoin Lanea', 'St. Pullto ', 'Campolia', 'Brazil', '3213', 'Roque', '3232280222', 'roque.almedia@gmail.com', 1, 10),
	(2, 'Liabily', '43543555', 'liabily@gmail.com', NULL, 'Putio Vittoin Lanea', 'St. Pullto ', 'Campolia', 'China', '3213', 'Roque', '3232280222', 'roque.almedia@gmail.com', 1, 10),
	(3, 'Gibson', '409837283', 'gibson.aus@gmail.com', 3232323, 'Sydney', 'Sydney', 'Sydney', 'Australia', '1234', 'gibson.aus@gmail.com', '213232', 'gibson.aus@gmail.com', 1, 11);
...
-- Dumping data for table timemgmt1.flexi_attribute: ~2 rows (approximately)
...
INSERT INTO `flexi_attribute` (`id`, `model`, `name`, `type`, `uniqueid`) VALUES
	...
	(2, 'models.UserFlexi', 'Emergency Contact', 'string', 1);
...
-- Dumping data for table timemgmt1.leave_balance: ~76 rows (approximately)
...
-- Dumping data for table timemgmt1.leave_level: ~4 rows (approximately)
...
INSERT INTO `leave_level` (`id`, `leave_type`, `carry_forward`, `leave_x_id`, `role_leave_id`, `last_update`) VALUES
	(1, 'Sick Leave', 'NO', 1, NULL, '2015-04-27 17:39:05'),
	(2, 'Paid Leave', 'YES', 1, NULL, '2015-04-27 17:39:05'),
	(3, 'Casual Leave', 'NO', 1, NULL, '2015-04-27 17:39:05'),
	(4, 'Maternity Leave', 'NO', 1, NULL, '2015-04-27 17:39:06');
...
-- Dumping data for table timemgmt1.leave_x: ~1 rows (approximately)
...
-- Dumping data for table timemgmt1.organization: ~5 rows (approximately)
...
INSERT INTO `organization` (`id`, `organization_name`, `organization_type`, `organization_location`, `organization_profile_url`, `company_id`, `parent`) VALUES
	(1, 'Mindnerves - Asia', 'Head Quater', 'Pune', 'org1_1.jpg', 1, NULL),
	...
	(4, 'Baner', 'Testing Center', 'Baner', 'org1_4.jpg', 1, 2),
	(5, 'Hadapsar', 'Development Center', 'Hadapsar', 'org1_5.jpg', 1, 2);
...
CREATE TABLE IF NOT EXISTS `project` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_project_clientName_24` (`client_name_id`),
  KEY `ix_project_projectManager_25` (`project_manager_id`),
  KEY `ix_project_companyObj_26` (`company_obj_id`),
  CONSTRAINT `fk_project_companyObj_26` FOREIGN KEY (`company_obj_id`) REFERENCES `company` (`id`),
  CONSTRAINT `fk_project_clientName_24` FOREIGN KEY (`client_name_id`) REFERENCES `client` (`id`),
  CONSTRAINT `fk_project_projectManager_25` FOREIGN KEY (`project_manager_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `projectclassnode` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_projectclassnode_projectId_29` (`project_id_id`),
  CONSTRAINT `fk_projectclassnode_projectId_29` FOREIGN KEY (`project_id_id`) REFERENCES `projectclass` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.projectclassnode: ~5 rows (approximately)
...
INSERT INTO `projectclassnode` (`id`, `project_types`, `project_description`, `project_color`, `parent_id`, `level`, `project_id_id`) VALUES
	(1, 'Software', 'This is Software Template', NULL, NULL, 0, 1),
	(2, 'Requirement', 'Requirement Phase', '#fbfdaa', 1, 1, 1),
	(3, 'Development', 'Deveopment Phase', '#fbfdaa', 1, 1, 1),
	(4, 'Testing', 'Testing Phase', NULL, 1, 1, 1),
	(5, 'Production', 'Production Phase', NULL, 1, 1, 1);
...
CREATE TABLE IF NOT EXISTS `projectclassnodeattribut` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_projectclassnodeattribut_p_30` (`projectnode_id`),
  CONSTRAINT `fk_projectclassnodeattribut_p_30` FOREIGN KEY (`projectnode_id`) REFERENCES `projectclassnode` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.projectclassnodeattribut: ~7 rows (approximately)
...
INSERT INTO `projectclassnodeattribut` (`id`, `name`, `type`, `value`, `projectnode_id`) VALUES
	(1, 'Language Used', 'String', NULL, 2),
	(2, 'Tools Used', 'String', NULL, 2),
	(3, 'Checklist', 'Checkbox', 'Need Mockups?\nNeed DFD Diagrams?', 2),
	(5, 'Checklist', 'Checkbox', 'Is Coding Standard followed?\nIs Code written in OOP way?\nIs indentation done?', 3),
	(6, 'How much Code coverage?', 'Radio', 'Yes\nNo', 3),
	(7, 'Checklist', 'Checkbox', 'Unit Testing \nAutomated Testing\nUI Testing\nIntegration Testing', 4),
	(8, NULL, NULL, NULL, 5);
...
CREATE TABLE IF NOT EXISTS `projectinstance` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_projectinstance_userid_31` (`userid_id`),
  CONSTRAINT `fk_projectinstance_userid_31` FOREIGN KEY (`userid_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.projectinstance: ~3 rows (approximately)
/*!40000 ALTER TABLE `projectinstance` DISABLE KEYS */;
INSERT INTO `projectinstance` (`id`, `project_name`, `project_description`, `client_name`, `start_date`, `end_date`, `status`, `client_id`, `projectid`, `percentage`, `userid_id`) VALUES
	(1, 'NetDealer', 'This is online toys distribution ERP', 'Roque', NULL, NULL, NULL, 1, 1, NULL, 1),
	(2, 'IKitchen', 'ERP', 'Liabily', '01-04-2015', '31-05-2015', 'Inprogress', 2, 1, 50, 3),
	(3, 'Toy Distributor', 'Toy shop online', 'Roque', '08-01-2015', '16-06-2015', 'Inprogress', 1, 1, 70, 1);
...
CREATE TABLE IF NOT EXISTS `projectinstancenode` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_projectinstancenode_Projec_32` (`projectclassnode_id`),
  KEY `ix_projectinstancenode_suppli_33` (`supplier_id`),
  CONSTRAINT `fk_projectinstancenode_suppli_33` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id`),
  CONSTRAINT `fk_projectinstancenode_Projec_32` FOREIGN KEY (`projectclassnode_id`) REFERENCES `projectclassnode` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.projectinstancenode: ~5 rows (approximately)
/*!40000 ALTER TABLE `projectinstancenode` DISABLE KEYS */;
INSERT INTO `projectinstancenode` (`id`, `projectclassnode_id`, `projecttypeid`, `projectinstanceid`, `start_date`, `end_date`, `task_compilation`, `weightage`, `project_manager`, `status`, `color`, `supplier_id`) VALUES
	(1, 1, 1, 2, '2015-04-01 00:00:00', '2015-05-31 00:00:00', 50, 1, NULL, 'Inprogress', '#00ff00', NULL),
	(2, 2, 1, 2, '2015-04-01 00:00:00', '2015-05-01 00:00:00', 50, 1, NULL, 'Inprogress', '#ff0000', NULL),
	(3, 3, 1, 2, '2015-04-13 00:00:00', '2015-04-14 00:00:00', 0, 1, NULL, NULL, NULL, NULL),
	(4, 1, 1, 3, '2015-01-08 00:00:00', '2015-06-16 00:00:00', 70, 1, NULL, 'Inprogress', '#00ff00', NULL),
	(5, 2, 1, 3, '2015-02-10 00:00:00', '2015-05-13 00:00:00', 70, 1, NULL, 'Inprogress', '#ff0000', NULL);
/*!40000 ALTER TABLE `projectinstancenode` ENABLE KEYS */;


-- Dumping structure for table timemgmt1.projectinstancenode_user
CREATE TABLE IF NOT EXISTS `projectinstancenode_user` (
  `projectinstancenode_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`projectinstancenode_id`,`user_id`),
  KEY `fk_projectinstancenode_user_u_02` (`user_id`),
  CONSTRAINT `fk_projectinstancenode_user_u_02` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_projectinstancenode_user_p_01` FOREIGN KEY (`projectinstancenode_id`) REFERENCES `projectinstancenode` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.projectinstancenode_user: ~4 rows (approximately)
/*!40000 ALTER TABLE `projectinstancenode_user` DISABLE KEYS */;
INSERT INTO `projectinstancenode_user` (`projectinstancenode_id`, `user_id`) VALUES
	(4, 3),
	(5, 3),
	(1, 7),
	(1, 8);
/*!40000 ALTER TABLE `projectinstancenode_user` ENABLE KEYS */;
...
-- Dumping data for table timemgmt1.projectinstance_supplier: ~6 rows (approximately)
...
-- Dumping data for table timemgmt1.projectinstance_user: ~7 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `project_comment` (
  ...
  `projectinstanceid` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_project_comment_user_27` (`user_id`),
  CONSTRAINT `fk_project_comment_user_27` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.project_comment: ~1 rows (approximately)
/*!40000 ALTER TABLE `project_comment` DISABLE KEYS */;
INSERT INTO `project_comment` (`id`, `project_comment`, `user_id`, `commet_date`, `projectinstanceid`) VALUES
	(1, 'I have done with task 1', 2, '2015-04-27 00:00:00', 5);
...
CREATE TABLE IF NOT EXISTS `project_flexi` (
  ...
  `value` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_project_flexi_project_28` (`project_id`),
  CONSTRAINT `fk_project_flexi_project_28` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Dumping data for table timemgmt1.role_leave: ~64 rows (approximately)
...
-- Dumping data for table timemgmt1.role_level: ~16 rows (approximately)
...
INSERT INTO `role_level` (`id`, `role_x_id`, `role_level`, `role_name`, `reporting_to`, `final_approval`, `permissions`, `role_description`, `parent_id`, `department_id`, `last_update`) VALUES
	...
	(5, NULL, NULL, 'VP (Managment)', NULL, NULL, NULL, 'Vice President - Management', 2, 8, '2015-04-26 15:20:26'),
	...
	(16, 2, NULL, 'Junior Expert', NULL, NULL, NULL, 'This is Junior Level Expert role', 9, 4, '2015-04-27 17:35:55');
...
-- Dumping data for table timemgmt1.role_x: ~3 rows (approximately)
...
-- Dumping data for table timemgmt1.saveattributes: ~6 rows (approximately)
/*!40000 ALTER TABLE `saveattributes` DISABLE KEYS */;
INSERT INTO `saveattributes` (`id`, `attribut_value`, `attribut_name`, `type`, `projectattrid`, `projectinstancenode_id`) VALUES
	(1, 'Java', NULL, NULL, 1, 2),
	(2, 'Eclipse , Visio', NULL, NULL, 2, 2),
	(3, 'Need Mockups?,Need DFD Diagrams?,', NULL, NULL, 3, 2),
	(4, '', NULL, NULL, 1, 5),
	(5, '', NULL, NULL, 2, 5),
	(6, 'Need Mockups?,Need DFD Diagrams?,', NULL, NULL, 3, 5);
...
CREATE TABLE IF NOT EXISTS `supplier` (
  ...
  KEY `ix_suplier_user_10` (`user_id`),
  CONSTRAINT `fk_suplier_user_10` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_supplier_company_39` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Dumping data for table timemgmt1.supplier: ~3 rows (approximately)
...
INSERT INTO `supplier` (`id`, `supplier_name`, `phone_no`, `email`, `password`, `fax`, `address`, `street`, `city`, `country`, `pin`, `contact_name`, `contact_phone`, `contact_email`, `company_id`, `user_id`) VALUES
	(1, 'Liabily LLP', '9028022291', 'jagbir.paul@gmail.com', 'qwer123', NULL, 'Singapore', 'Singapore', 'Singapore', 'Singapore', '32123', 'Billy ', '9028022291', 'billy@liabilly.com', 1, 12),
	(2, 'Strynet LLP', '4908789323', 'tarun.bansal@gmail.com', 'qwer123', NULL, 'Australia', 'Australia', 'Australia', 'Singapore', '32123', 'Tarun bansal', '9028022291', 'billy@liabilly.com', 1, 13),
	(3, 'Gibson SW LTD', '4012345654', 'gibson1@gmail.com', '1212', NULL, 'Aus Sydney', 'Sydney', 'Sydney', 'Australia', '2132', 'gibsonsw', '4023456543', 'gibsonsw@gmail.com', 1, 14);
...
-- Dumping data for table timemgmt1.timesheet: ~10 rows (approximately)
...
INSERT INTO `timesheet` (`id`, `user_id`, `status`, `week_of_year`, `year`, `timesheet_with_id`, `level`, `process_instance_id`, `tid`, `last_update_date`) VALUES
	...
	(12, 4, 0, 22, 2015, 4, 0, NULL, NULL, '2015-04-26 10:11:41'),
	(13, 4, 0, 23, 2015, 4, 0, NULL, NULL, '2015-04-26 10:35:26');
...
-- Dumping data for table timemgmt1.timesheet_days: ~98 rows (approximately)
...
INSERT INTO `timesheet_days` (`id`, `day`, `timesheet_date`, `time_from`, `time_to`, `work_minutes`, `timesheet_row_id`) VALUES
	...
	(153, 'monday', '2015-05-25', '12:12', '12:12', 0, 23),
	(154, 'tuesday', '2015-05-26', '12:09', '16:16', 247, 23),
	(155, 'wednesday', '2015-05-27', '14:49', '17:17', 148, 23),
	(156, 'thursday', '2015-05-28', NULL, NULL, NULL, 23),
	(157, 'friday', '2015-05-29', NULL, NULL, NULL, 23),
	(158, 'saturday', '2015-05-30', NULL, NULL, NULL, 23),
	(159, 'sunday', '2015-05-31', NULL, NULL, NULL, 23),
	(160, 'monday', '2015-06-01', '12:21', '21:12', 531, 24),
	(161, 'tuesday', '2015-06-02', '21:56', '23:22', 86, 24),
	(162, 'wednesday', '2015-06-03', NULL, NULL, NULL, 24),
	(163, 'thursday', '2015-06-04', NULL, NULL, NULL, 24),
	(164, 'friday', '2015-06-05', NULL, NULL, NULL, 24),
	(165, 'saturday', '2015-06-06', NULL, NULL, NULL, 24),
	(166, 'sunday', '2015-06-07', NULL, NULL, NULL, 24);
...
-- Dumping data for table timemgmt1.timesheet_days_actual: ~35 rows (approximately)
...
-- Dumping data for table timemgmt1.timesheet_row: ~14 rows (approximately)
...
-- Dumping data for table timemgmt1.user: ~22 rows (approximately)
...
INSERT INTO `user` (`id`, `salutation`, `employee_id`, `first_name`, `middle_name`, `last_name`, `email`, `gender`, `status`, `hire_date`, `annual_income`, `hourlyrate`, `companyobject_id`, `designation`, `department`, `role_id`, `level_id`, `manager_id`, `release_date`, `hrmanager_id`, `permissions`, `temp_password`, `password`, `reset_flag`, `failed_login_attempt`, `create_date`, `modified_date`, `password_reset`, `user_status`, `process_instance_id`, `last_update`, `usertype`, `organization_id`) VALUES
	...
	(5, NULL, NULL, 'Akash', 'Sarpanch', 'Shinde', 'akash@mindnerves.com', NULL, 'OnRolls', NULL, NULL, NULL, 1, 'VP (Managment)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'qwer123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-22 12:28:12', NULL, NULL),
	(6, 'Mr', '1', 'Jagbir', 'Paul', 'Singh', 'jagbirs@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CTO', 'Development', 3, NULL, 4, NULL, NULL, 'ManageClient|ManageProject|CaseTo|UserPermissions|SearchTimesheet|WeekReport|LeaveBucket|Delegate|Mail|Holiday|ManageUser|CreateTimesheet|CreateTimesheets|RolePermissions|LeaveSettings|Week|TodayAll|DefineLeaves|OrgHierarchy|DefineFlexiAttribute|Today|MyBucket|Notification|ApplyLeave|ManageProjects|Case|ManageSupplier|ManageTask|DefineDepartments|DefineRoles|Month|TeamRate|ProjectReport||', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-27 17:48:45', NULL, NULL),
	...
	(8, NULL, NULL, 'software', 'abc', 'engineer', 'abc@gmail.com', NULL, 'OnRolls', NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-24 21:41:53', NULL, NULL),
	(9, 'Mr', '123', 'Yogesh', 'pqr', 'Patil', 'yogesh@gmail.com', 'Male', 'OnRolls', '2015-04-15 00:00:00', 1234, 23, 2, 'Development Expert', 'Development', 13, NULL, 4, '2015-04-29 00:00:00', NULL, 'DefineProjects|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-26 12:12:25', NULL, NULL),
	(10, NULL, NULL, NULL, NULL, NULL, 'roqu@gmail.com', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'v6s2p8', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-26 12:38:12', 'Customer User', NULL),
	(11, NULL, NULL, NULL, NULL, NULL, 'gibson.aus@gmail.com', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '4p3rdl', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-26 12:51:41', 'Customer User', NULL),
	(12, NULL, NULL, NULL, NULL, NULL, 'xyz@gmail.com', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'j22ec9', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-26 12:54:25', 'Supplier User', NULL),
	(13, NULL, NULL, NULL, NULL, NULL, 'qwer@gmail.com', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'j22ec9', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-26 12:54:25', 'Supplier User', NULL),
	(14, NULL, NULL, NULL, NULL, NULL, 'gibson1@gmail.com', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'e3fszk', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-26 13:00:27', 'Supplier User', NULL),
	(15, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg0@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(16, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg01@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(17, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg02@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(18, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg03@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(19, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg04@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(20, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg05@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(21, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg06@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL),
	(22, 'Mr', '2', 'Amit', '', 'Goyal', 'amitg07@mindnerves.com', 'Male', 'OnRolls', '2012-01-04 00:00:00', 123456, 59.35, 1, 'CEO', 'Marketing', 2, NULL, 4, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|Delegate|RolePermissions|UserPermissions|MyBucket|LeaveBucket|TeamRate|ProjectReport|Mail|Notification|DefineRoles|DefineLeaves|OrgHierarchy|ManageSupplier|ManageProjects|DefineDepartments|DefineFlexiAttribute|Case|LeaveSettings|CaseTo|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-25 19:47:18', NULL, NULL);
...
-- Dumping data for table timemgmt1.user_flexi: ~4 rows (approximately)
...
INSERT INTO `user_flexi` (`id`, `user_id`, `flexi_id`, `value`) VALUES
	...
	(2, 9, 1, ''),
	(3, 6, 1, '[{"n":"my-view.PNG","s":75410,"ct":"image/png"}]'),
	(4, 6, 2, '32345432');
