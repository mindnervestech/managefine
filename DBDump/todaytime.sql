...
-- Dumping data for table timemgmt.apply_leave: ~1 rows (approximately)
...
-- Dumping data for table timemgmt.case_data: ~12 rows (approximately)
...
-- Dumping data for table timemgmt.case_flexi: ~9 rows (approximately)
...
-- Dumping data for table timemgmt.case_notes: ~6 rows (approximately)
...
-- Dumping data for table timemgmt.department: ~2 rows (approximately)
...
-- Dumping data for table timemgmt.flexi_attribute: ~19 rows (approximately)
...
-- Dumping data for table timemgmt.leave_balance: ~9 rows (approximately)
...
-- Dumping data for table timemgmt.leave_x: ~2 rows (approximately)
...
-- Dumping data for table timemgmt.projectclass: ~10 rows (approximately)
...
-- Dumping data for table timemgmt.projectclassnode: ~49 rows (approximately)
...
-- Dumping data for table timemgmt.projectclassnodeattribut: ~55 rows (approximately)
...
-- Dumping data for table timemgmt.projectinstance: ~7 rows (approximately)
...
INSERT INTO `projectinstance` (`id`, `project_name`, `project_description`, `projectid`, `client_id`, `client_name`, `start_date`, `end_date`) VALUES
	...
	(38, 'this is test project', 'this is created by jagbir', 14, 1, 'abcd', NULL, NULL);
...
-- Dumping data for table timemgmt.projectinstancenode: ~11 rows (approximately)
...
-- Dumping data for table timemgmt.project_task: ~2 rows (approximately)
...
-- Dumping data for table timemgmt.role: ~14 rows (approximately)
...
-- Dumping data for table timemgmt.saveattributes: ~17 rows (approximately)
...
INSERT INTO `saveattributes` (`id`, `attribut_value`, `projectattrid`, `projectinstancenode_id`, `attribut_name`, `type`) VALUES
	...
	(26, 'sasa', 120, 21, NULL, NULL),
	(27, '11', 121, 21, NULL, NULL);
...
-- Dumping data for table timemgmt.supplier_flexi: ~5 rows (approximately)
...
-- Dumping data for table timemgmt.task_project: ~3 rows (approximately)
...
-- Dumping data for table timemgmt.timesheet: ~11 rows (approximately)
...
-- Dumping data for table timemgmt.timesheet_actual: ~4 rows (approximately)
...
-- Dumping data for table timemgmt.timesheet_days: ~63 rows (approximately)
...
-- Dumping data for table timemgmt.user: ~7 rows (approximately)
...
INSERT INTO `user` (`id`, `salutation`, `employee_id`, `first_name`, `middle_name`, `last_name`, `email`, `gender`, `status`, `hire_date`, `annual_income`, `hourlyrate`, `companyobject_id`, `designation`, `role_id`, `level_id`, `manager_id`, `release_date`, `hrmanager_id`, `permissions`, `temp_password`, `password`, `reset_flag`, `failed_login_attempt`, `create_date`, `modified_date`, `password_reset`, `user_status`, `process_instance_id`, `last_update`, `department`) VALUES
	...
	(3, 'Mr', '1', 'Project', '', 'Manager', 'pm@ggg.com', 'Male', 'OnRolls', '2015-02-23 00:00:00', 1000000, 480.77, 2, 'Project Manager', 20, NULL, 2, NULL, NULL, 'ManageUser|ManageClient|ManageProject|ManageTask|ApplyLeave|CreateTimesheet|SearchTimesheet|CreateTimesheets|Today|Week|Month|Holiday|TodayAll|WeekReport|UserRequest|MyBucket|', 0, 'qwe123', NULL, NULL, NULL, NULL, NULL, 'Approved', NULL, '2015-04-10 17:53:37', NULL),
...
-- Dumping data for table timemgmt.user_flexi: ~46 rows (approximately)
