...
angular.module('app')
  .controller('MainCtrl', function ($scope,$http, $interval, stackedAreaChartSampleData, pieChartSampleData, RandomTimeSeriesDataModel, RandomTopNDataModel, ProjectDataModel, TaskDataModel) {
