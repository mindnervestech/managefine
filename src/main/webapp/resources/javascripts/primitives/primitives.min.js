/*
 Basic Primitives orgDiagram v2.0.17
...
primitives.orgdiagram.ItemType={Regular:0,Assistant:1,Adviser:2,SubAssistant:4,SubAdviser:5,GeneralPartner:6,LimitedPartner:7,AdviserPartner:8};primitives.common.HorizontalAlignmentType={Center:0,Left:1,Right:2};primitives.common.GroupByType={Parents:0,Children:1};primitives.common.GraphicsType={SVG:0,Canvas:1,VML:2};primitives.common.Enabled={Auto:0,True:1,False:2};primitives.common.ElbowType={None:0,Dot:1,Bevel:2,Round:3};primitives.common.ConnectorType={Squared:0,Angular:1,Curved:2};
...
b+d+g,e,f);break;case 6:j=new primitives.common.Rect(a,b+d+g,e,f);break;case 7:j=new primitives.common.Rect(a-e-g,b+d/2-f/2,e,f);break;case 9:j=new primitives.common.Rect(a-e-g,b,e,f);break;case 10:j=new primitives.common.Rect(a-e-g,b+d-f,e,f);break;default:j=new primitives.common.Rect(a+c/2-e/2,b+d+g,e,f)}return j};
primitives.common.BaseShape.prototype._getArrow=function(a,b,c,d,e){for(var f=[],g,h,j,i=[new primitives.common.Point(c,-d/2),new primitives.common.Point(0,0),new primitives.common.Point(c,d/2),new primitives.common.Point(3*(c/4),0)],c=0,d=i.length;c<d;c+=1)g=i[c],h=g.x*Math.cos(e)-g.y*Math.sin(e),j=g.x*Math.sin(e)+g.y*Math.cos(e),g.x=h+a,g.y=j+b;f.push(new primitives.common.MoveSegment(i[0].x,i[0].y));f.push(new primitives.common.LineSegment(i[1].x,i[1].y));f.push(new primitives.common.LineSegment(i[2].x,
i[2].y));f.push(new primitives.common.QuadraticArcSegment(i[3].x,i[3].y,i[0].x,i[0].y));return f};primitives.common.BaseShape.prototype._quadraticBezierPoint=function(a,b,c,d){return new primitives.common.Point((1-d)*(1-d)*a.x+2*(1-d)*d*b.x+d*d*c.x,(1-d)*(1-d)*a.y+2*(1-d)*d*b.y+d*d*c.y)};primitives.common.BaseShape.prototype._betweenPoint=function(a,b){return new primitives.common.Point((a.x+b.x)/2,(a.y+b.y)/2)};
...
primitives.common.Connector.prototype.draw=function(a,b,c){var d,e,f,g=[],h=[],j,i,k,l,n,m,p,q;j=6*this.lineWidth;var r=4*this.lineWidth;q=1.5*r;var s,t,v=0,w=0,u,a=(new primitives.common.Rect(a)).offset(this.offset),b=(new primitives.common.Rect(b)).offset(this.offset);l=[];switch(this.connectorShapeType){case 1:l=[-q/2,q/2];break;case 0:l=[0]}this.transform=new primitives.common.Transform;this.transform.size=this.panelSize;this.transform.setOrientation(this.orientationType);this.transform.transformRect(a.x,
...
s.width:0,5*j);if(a.right()+v<b.left()||a.left()>b.right()+v)if(a.left()>b.right()?(d=new primitives.common.Point(a.left(),a.verticalCenter()),e=new primitives.common.Point(b.right(),b.verticalCenter()),v=7,w=3):(d=new primitives.common.Point(a.right(),a.verticalCenter()),e=new primitives.common.Point(b.left(),b.verticalCenter()),v=3,w=7),f=new primitives.common.Rect(d,e),p=d.y<=e.y,m=d.x<e.x,f.height<f.width){f.height<2*j&&f.offset(0,p?2*j:0,0,p?0:2*j);i=0;for(k=l.length;i<k;i+=1)n=l[i],g.push(new primitives.common.MoveSegment(d.x,
d.y+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),(p?f.top():f.bottom())+n,e.x,e.y+n));l=s.width<2*(f.width/5)?this._quadraticBezierPoint(d,new primitives.common.Point(f.horizontalCenter(),p?f.top():f.bottom()),e,0.5):new primitives.common.Point(d.x,p?f.top():f.bottom());t=new primitives.common.Rect(l.x+(m?q:-s.width-q),p?l.y-s.height-j:l.y+j,s.width,s.height)}else{i=0;for(k=l.length;i<k;i+=1)n=l[i],g.push(new primitives.common.MoveSegment(d.x,d.y+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+
n*(p!=m?1:-1),(p?f.top():f.bottom())+n,f.horizontalCenter()+n*(p!=m?1:-1),f.verticalCenter()+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+n*(p!=m?1:-1),(p?f.bottom():f.top())+n,e.x,e.y+n));t=new primitives.common.Rect(f.horizontalCenter()+(p!=m?q:-(q+s.width)),f.verticalCenter()-s.height/2,s.width,s.height)}else if(a.verticalCenter()<b.top()||a.verticalCenter()>b.bottom()){m=a.x<u.width/2;d=new primitives.common.Point(m?a.right():a.left(),a.verticalCenter());e=new primitives.common.Point(m?
b.right():b.left(),b.verticalCenter());w=v=m?3:7;f=new primitives.common.Rect(d,e);f.offset(10*j,0,10*j,0);p=d.y<=e.y;i=0;for(k=l.length;i<k;i+=1)n=l[i],g.push(new primitives.common.MoveSegment(d.x,d.y+n)),g.push(new primitives.common.QuadraticArcSegment(m?f.right()+n*(p?-1:1):f.left()-n*(p?-1:1),f.verticalCenter(),m?b.right():b.left(),b.verticalCenter()-n));l=this._quadraticBezierPoint(d,new primitives.common.Point(m?f.right():f.left(),f.verticalCenter()),e,0.5);t=new primitives.common.Rect(l.x+
(m?q/2:-q/2-s.width),l.y-s.height/2,s.width,s.height)}else{d=new primitives.common.Point(a.horizontalCenter(),a.top());e=new primitives.common.Point(b.horizontalCenter(),b.top());w=v=1;f=new primitives.common.Rect(d,e);f.offset(0,7*j,0,0);m=d.x<e.x;i=0;for(k=l.length;i<k;i+=1)n=l[i],g.push(new primitives.common.MoveSegment(d.x+n,d.y)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),f.top()-n*(m?-1:1),b.horizontalCenter()-n,b.top()));l=this._quadraticBezierPoint(d,new primitives.common.Point(f.horizontalCenter(),
f.top()),e,0.5);t=new primitives.common.Rect(l.x-s.width/2,l.y-(this.labelOffset+s.height),s.width,s.height)}if(0<g.length){this.transform.transformSegments(g,!0);switch(this.connectorShapeType){case 1:l=g[g.length/2-1];m=Math.atan2(l.cpY-l.y,l.cpX-l.x);h=h.concat(this._getArrow(l.x,l.y,j,r,m));m=this._offsetPoint(new primitives.common.Point(l.x,l.y),new primitives.common.Point(l.cpX,l.cpY),r);l.x=m.x;l.y=m.y;q=g[g.length/2];l=g[g.length/2+1];m=Math.atan2(l.cpY-q.y,l.cpX-q.x);h=h.concat(this._getArrow(q.x,
q.y,j,r,m));m=this._offsetPoint(new primitives.common.Point(q.x,q.y),new primitives.common.Point(l.cpX,l.cpY),r);q.x=m.x;q.y=m.y;break;case 0:l=g[g.length-1],m=Math.atan2(l.cpY-l.y,l.cpX-l.x),h=h.concat(this._getArrow(l.x,l.y,j,r,m)),m=this._offsetPoint(new primitives.common.Point(l.x,l.y),new primitives.common.Point(l.cpX,l.cpY),r),l.x=m.x,l.y=m.y}j={};null!==this.borderColor&&(j.borderColor=this.color);j.lineWidth=this.lineWidth;j.lineType=this.lineType;this.m_graphics.polyline(g,j);g={opacity:1};
...
primitives.common.Graphics.prototype.template=function(a,b,c,d,e,f,g,h,j,i,k,l,n){var c=this.m_activePlaceholder,d="template"+(null!==i?i:primitives.common.hashCode(j)),m=0,i=this.m_cache.get(c.name,c.activeLayer.name,d);null!==n&&void 0!==n["border-width"]&&(m=this.boxModel?this.getPxSize(n["border-width"]):0);a={width:g-m+"px",height:h-m+"px",top:b+f+"px",left:a+e+"px"};jQuery.extend(a,n);null==l&&(l=new primitives.common.RenderEventArgs);null==i?(i=jQuery(j),jQuery.extend(a,{position:"absolute",
padding:"0px",margin:"0px"},n),primitives.common.css(i,a),l.element=i,l.renderingMode=0,null!==k&&this.m_widget._trigger(k,null,l),c.activeLayer.canvas.append(i),this.m_cache.put(c.name,c.activeLayer.name,d,i)):(l.element=i,l.renderingMode=1,primitives.common.css(i,a),null!==k&&this.m_widget._trigger(k,null,l));return i};
...
primitives.orgdiagram.BaseController=function(){this.transform=this.graphics=null;this._treeItemConfigs={};this._orgItems={};this._orgItemChildren={};this._orgItemRoot=null;this._orgPartners={};this._treeItems={};this._treeItemCounter=0;this._treeItemsByUserId={};this._treeLevels=[];this._leftMargins={};this._rightMargins={};this._templates={};this.m_scrollPanel=this._highlightTreeItem=this._cursorTreeItem=this._printPreviewTemplateHashCode=this._printPreviewTemplate=this._annotationLabelTemplateHashCode=
this._annotationLabelTemplate=this._groupTitleTemplateHashCode=this._groupTitleTemplate=this._buttonsTemplateHashCode=this._buttonsTemplate=this._checkBoxTemplateHashCode=this._checkBoxTemplate=this._defaultTemplate=null;this.m_scrollPanelRect=new primitives.common.Rect(0,0,0,0);this.m_placeholder=null;this.m_placeholderRect=new primitives.common.Rect(0,0,0,0);this.m_calloutShape=this.m_calloutPlaceholder=null;this.boxModel=jQuery.support.boxModel;this._cancelMouseClick=!1;this._itemsInterval=[];
this._scale=null;this.scale=1;this._debug=this.showElbowDots=this.showInvisibleSubTrees=!1};primitives.orgdiagram.BaseController.prototype._create=function(){this.element.addClass("ui-widget");this._createLayout();this._bind();this.transform=this.graphics=null;this._redraw()};primitives.orgdiagram.BaseController.prototype.destroy=function(){this._unbind();this._clean();this._cleanLayout()};
primitives.orgdiagram.BaseController.prototype._clean=function(){null!==this.graphics&&this.graphics.clean();this.transform=this.graphics=null};primitives.orgdiagram.BaseController.prototype._cleanLayout=function(){this.options.enablePanning&&this._mouseDestroy();this.element.find("."+this.widgetEventPrefix).remove()};
...
primitives.orgdiagram.BaseController.prototype._getNextLevelTreeItem=function(a,b){var c=a.actualPosition.horizontalCenter(),d,e,f,g,h=null,j=null,i,k,l,n=b?this._treeLevels.slice(a.level+1,this._treeLevels.length):this._treeLevels.slice(0,a.level).reverse();f=0;for(g=n.length;f<g;f+=1){k=n[f].treeItems;d=0;for(e=k.length;d<e;d+=1)if(l=this._treeItems[k[d]],1==l.actualVisibility)if(i=Math.abs(c-l.actualPosition.horizontalCenter()),i<j||null==j)j=i,h=l;else break;if(null!=j)break}return h};
...
primitives.orgdiagram.BaseController.prototype._redraw=function(){this._clean();this.graphics=primitives.common.createGraphics(this.options.graphicsType,this);this.graphics.debug=this._debug;this.transform=new primitives.common.Transform;this.options.actualGraphicsType=this.graphics.graphicsType;this.m_calloutShape=new primitives.common.Callout(this.graphics);this._readTemplates();this._createCheckBoxTemplate();this._createButtonsTemplate();this._createGroupTitleTemplate();this._createAnnotationLabelTemplate();
...
primitives.orgdiagram.BaseController.prototype._tracePathAnnotations=function(){var a,b,c,d,e,f,g,h,j,i,k,l;a=0;for(b=this.options.annotations.length;a<b;a+=1)switch(c=this.options.annotations[a],c.annotationType){case 2:if(null==j&&(j=this._getConnectionsGraph()),null!=c.items&&0<c.items.length){k=c.items.slice(0);g=this._treeItemsByUserId[k[0]];if(1==k.length){c=0;for(d=g.logicalParents.length;c<d;c+=1)e=this._treeItems[g.logicalParents[c]],null!=e.itemConfig&&k.push(e.itemConfig.id)}if(1<k.length){c=
1;for(d=k.length;c<d;c+=1){e=this._treeItemsByUserId[k[c]];i=primitives.common.getShortestPath(j,g,e);e=1;for(f=i.length;e<f;e+=1)l=j[i[e-1]][i[e]],h=this._treeItems[l.id],h.highlightPath=1,l.hasOwnProperty("partnerid")&&(h=this._treeItems[l.partnerid],h.partnerHighlightPath=1)}}}}};
primitives.orgdiagram.BaseController.prototype._getConnectionsGraph=function(){var a,b,c,d,e,f,g,h,j,i,k={};b=0;for(c=this._treeLevels.length;b<c;b+=1){a=this._treeLevels[b];d=0;for(e=a.treeItems.length;d<e;d+=1){h=a.treeItems[d];h=this._treeItems[h];h.connectorPlacement&8?j=[a.treeItems[h.levelPosition-1]]:h.connectorPlacement&2?j=[a.treeItems[h.levelPosition+1]]:h.connectorPlacement&1?(f=this._treeItems[h.visualParentId],j=1<f.partners.length?f.partners.slice(0):[h.visualParentId],0<f.extraPartners.length&&
(j=j.concat(f.extraPartners))):j=[];f=0;for(g=j.length;f<g;f+=1)i=j[f],k.hasOwnProperty(h.id)||(k[h.id]={}),k[h.id][i]=1==g?{id:h.id}:{id:h.id,partnerid:i},k.hasOwnProperty(i)||(k[i]={}),k[i][h.id]=1==g?{id:h.id}:{id:h.id,partnerid:i}}}return k};
...
primitives.orgdiagram.BaseController.prototype._drawAnnotations=function(){var a;a=8;var b,c,d,e,f,g,h,j,i,k,l;b=0;for(c=this.options.annotations.length;b<c;b+=1)switch(k=this.options.annotations[b],k.annotationType){case 0:if(null!=k.fromItem&&null!=k.toItem&&(e=this._treeItemsByUserId[k.fromItem],f=this._treeItemsByUserId[k.toItem],null!=e&&null!=f)){h=new primitives.orgdiagram.ConnectorAnnotationConfig;g=new primitives.common.Connector(this.graphics);g.orientationType=this.options.orientationType;
j="connectorShapeType labelPlacementType offset lineWidth color lineType labelSize zOrderType".split(" ");a=0;for(d=j.length;a<d;a+=1)i=j[a],g[i]=k.hasOwnProperty(i)?k[i]:h[i];g.labelTemplate=this._annotationLabelTemplate;g.labelTemplateHashCode=this._annotationLabelTemplateHashCode;g.hasLabel=!primitives.common.isNullOrEmpty(k.label);l=new primitives.common.RenderEventArgs;l.context=k;switch(g.zOrderType){case 1:a=1;break;default:a=8}a=this.graphics.activate("placeholder",a);g.panelSize=a.size;this.transform.transformRect(e.actualPosition.x,
...
if(!e.isEmpty()){g=new primitives.common.Shape(this.graphics);h=new primitives.orgdiagram.ShapeAnnotationConfig;j="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");a=0;for(d=j.length;a<d;a+=1)i=j[a],g[i]=k.hasOwnProperty(i)?k[i]:h[i];switch(g.zOrderType){case 2:a=8;break;case 1:a=1;break;default:switch(g.shapeType){case 3:case 1:case 2:a=8;break;default:a=1}}a=this.graphics.activate("placeholder",a);g.position=
...
primitives.orgdiagram.BaseController.prototype._redrawConnector=function(a,b,c,d){var e,f,g,h,j,i,k,l,n,m=0,p,q=0==this.options.connectorType,r;n=0<c.partnerConnectorOffset?d.connectorShift-d.levelSpace/2*(d.partnerConnectorOffset-c.partnerConnectorOffset+1):c.connectorPlacement&4?c.actualPosition.bottom():d.connectorShift;1>=c.partnerConnectorOffset?b.selectPalette(0):1<c.partnerConnectorOffset?b.selectPalette(c.partnerConnectorOffset-1):b.selectPalette(d.partnerConnectorOffset);0<c.visualChildren.length&&
(e=4===c.actualVisibility&&c.id===this._visualRootItem,l=c.actualPosition.horizontalCenter());if(1<c.partners.length||0<c.extraPartners.length){f=[];g=c.partners;for(i=0;i<g.length;i+=1)h=this._treeItems[g[i]],p=new primitives.orgdiagram.ConnectorPoint(h.actualPosition.horizontalCenter(),h.actualPosition.bottom()),p.isSquared=!0,p.highlightPath=h.partnerHighlightPath,p.connectorStyleType=h.partnerHighlightPath?2:1,f.push(p);g=c.extraPartners;for(i=0;i<g.length;i+=1)h=this._treeItems[g[i]],p=new primitives.orgdiagram.ConnectorPoint(h.actualPosition.horizontalCenter(),
h.actualPosition.bottom()),p.isSquared=!0,p.highlightPath=h.partnerHighlightPath,p.connectorStyleType=h.partnerHighlightPath?2:0,f.push(p);0<f.length&&(f.sort(function(a,b){return a.x-b.x}),0==c.visualChildren.length&&(l=(f[0].x+f[f.length-1].x)/2),this._drawTopConnectors(b,l,n,f,!0,a))}if(0<c.visualChildren.length){f=[];k=!1;g=c.visualChildren;for(i=0;i<g.length;i+=1)if(h=this._treeItems[g[i]],j=this._treeLevels[h.level],r=b.getPolyline(h.highlightPath?2:1).segments,h.connectorPlacement&8)j=this._treeItems[j.treeItems[h.levelPosition-
1]],this.transform.transformPoints(h.actualPosition.x,h.actualPosition.verticalCenter(),j.actualPosition.right(),h.actualPosition.verticalCenter(),!0,this,function(a,b,c,d){r.push(new primitives.common.MoveSegment(a,b));r.push(new primitives.common.LineSegment(c,d))});else if(h.connectorPlacement&2)j=this._treeItems[j.treeItems[h.levelPosition+1]],this.transform.transformPoints(h.actualPosition.right(),h.actualPosition.verticalCenter(),j.actualPosition.x,h.actualPosition.verticalCenter(),!0,this,
function(a,b,c,d){r.push(new primitives.common.MoveSegment(a,b));r.push(new primitives.common.LineSegment(c,d))});else if(h.connectorPlacement&1&&!e){j=!0;if(a)switch(h.actualVisibility){case 2:case 3:j=q}p=new primitives.orgdiagram.ConnectorPoint(h.actualPosition.horizontalCenter()+0,h.actualPosition.top());p.isSquared=j;p.connectorStyleType=h.highlightPath?2:1;f.push(p);k=k||p.isSquared}!e&&0<f.length&&(m=this._drawTopConnectors(b,l,d.connectorShift,f,k,a));e||this.transform.transformPoints(l,n,
l,d.connectorShift,!0,this,function(a,d,e,g){r=b.getPolyline(m).segments;this.showElbowDots&&(0!=this.options.elbowType&&0<c.partners.length)&&r.push(new primitives.common.DotSegment(a-1,d-1,2,2,1));r.push(new primitives.common.MoveSegment(a,d));r.push(new primitives.common.LineSegment(e,g));this.showElbowDots&&(0!=this.options.elbowType&&1<f.length)&&r.push(new primitives.common.DotSegment(e-1,g-1,2,2,1))})}};
primitives.orgdiagram.BaseController.prototype._drawTopConnectors=function(a,b,c,d,e,f){var g,h,j,i,k=[],l,n=0,m;if(e){k=[];g=0;for(j=d.length;g<j;g+=1)if(i=d[g],i.x<b&&!i.isSquared)k.push(i);else break;j=k.length;0<j&&(k[j-1].connectorStyleType=this._drawAngularConnectors(a,b,c,k,!1),n=Math.max(n,k[j-1].connectorStyleType));k=[];for(h=d.length-1;h>=g;h-=1)if(i=d[h],i.x>b&&!i.isSquared)k.push(i);else break;j=k.length;0<j&&(k[j-1].connectorStyleType=this._drawAngularConnectors(a,b,c,k,!1),n=Math.max(n,
k[j-1].connectorStyleType));for(k=g;k<=h;k+=1){i=d[k];m=a.getPolyline(i.connectorStyleType).segments;n=Math.max(n,i.connectorStyleType);e=this.options.dotItemsInterval/2;if(f)switch(this.options.elbowType){case 2:case 3:Math.abs(b-i.x)>e&&Math.abs(c-i.y)>e&&(i.hasElbow=!0,i.elbowPoint1=new primitives.common.Point(i.x,c+(c>i.y?-e:e)),i.elbowPoint2=new primitives.common.Point(i.x+(b>i.x?e:-e),c));break;case 1:0<h-g&&this.transform.transformPoints(i.x,c,i.x,i.y,!0,this,function(a,b){m.push(new primitives.common.DotSegment(a-
1,b-1,2,2,1))})}i.hasElbow?(this.transform.transformPoints(i.x,i.y,i.elbowPoint1.x,i.elbowPoint1.y,!0,this,function(a,b,c,d){m.push(new primitives.common.MoveSegment(a,b));m.push(new primitives.common.LineSegment(c,d))}),this.transform.transform3Points(i.elbowPoint1.x,i.elbowPoint1.y,i.elbowPoint1.x,i.elbowPoint2.y,i.elbowPoint2.x,i.elbowPoint2.y,!0,this,function(a,b,c,d,e,f){switch(this.options.elbowType){case 2:m.push(new primitives.common.MoveSegment(a,b));m.push(new primitives.common.LineSegment(e,
f));break;case 3:m.push(new primitives.common.MoveSegment(a,b)),m.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}})):this.transform.transformPoints(i.x,c,i.x,i.y,!0,this,function(a,b,c,d){m.push(new primitives.common.MoveSegment(a,b));m.push(new primitives.common.LineSegment(c,d))})}f={};e={};for(l in primitives.common.ConnectorStyleType)primitives.common.ConnectorStyleType.hasOwnProperty(l)&&(f[primitives.common.ConnectorStyleType[l]]=b,e[primitives.common.ConnectorStyleType[l]]=b);k=Math.max(0,
g-1);for(j=Math.min(h+1,d.length-1);k<=j;k+=1)i=d[k],f[i.connectorStyleType]=Math.min(f[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x),e[i.connectorStyleType]=Math.max(e[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x);d=b;for(k=2;0<=k;k-=1)m=a.getPolyline(k).segments,l=f[k],null!=l&&l<d&&(this.transform.transformPoints(l,c,d,c,!0,this,function(a,b,c,d){m.push(new primitives.common.MoveSegment(a,b));m.push(new primitives.common.LineSegment(c,d))}),d=l),l=e[k],null!=l&&l>b&&(this.transform.transformPoints(l,
c,b,c,!0,this,function(a,b,c,d){m.push(new primitives.common.MoveSegment(a,b));m.push(new primitives.common.LineSegment(c,d))}),b=l)}else n=Math.max(n,this._drawAngularConnectors(a,b,c,d,!0));return n};
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors=function(a,b,c,d,e){var f=null,g=d.length,h,j,i,k=0,f=e?b:d[g-1].x;j=new primitives.common.Point(f,c);for(b=0;b<g;b+=1)switch(h=d[b],i=a.getPolyline(h.connectorStyleType).segments,k=Math.max(k,h.connectorStyleType),this.transform.transformPoint(f,c,!0,this,function(a,b){i.push(new primitives.common.MoveSegment(a,b))}),this.options.connectorType){case 1:this.transform.transformPoint(h.x,h.y,!0,this,function(a,b){i.push(new primitives.common.LineSegment(a,
b))});break;case 2:h=new primitives.common.Rect(j,h),e?f>h.x?this.transform.transform3Points(h.right(),h.verticalCenter(),h.x,h.verticalCenter(),h.x,h.bottom(),!0,this,function(a,b,c,d,e,f){i.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):this.transform.transform3Points(h.x,h.verticalCenter(),h.right(),h.verticalCenter(),h.right(),h.bottom(),!0,this,function(a,b,c,d,e,f){i.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):f>h.x?this.transform.transformPoints(h.x,h.y,h.x,h.bottom(),
...
primitives.orgdiagram.BaseController.prototype._getTreeItemForMousePosition=function(a,b){var c=null,d=this,e,f,g;this.graphics.activate("placeholder",7);a/=this.scale;b/=this.scale;this.transform.transformPoint(a,b,!1,this,function(a,b){e=0;for(f=this._treeLevels.length;e<f;e+=1)if(g=d._treeLevels[e],0<g.activeTreeItems.length&&b>g.topConnectorShift&&b<=g.connectorShift){c=d._treeItems[primitives.common.binarySearch(g.activeTreeItems,function(c){c=d._treeItems[c];switch(c.actualVisibility){case 1:if(c.actualPosition.contains(a,
...
primitives.orgdiagram.BaseController.prototype._stretchToAvoidPageMargins=function(){var a=new primitives.common.Size(this.options.printPreviewPageSize),b=this,c,d,e,f,g,h;switch(this.options.orientationType){case 2:case 3:a.invert()}c=[];e=0;for(f=this._treeLevels.length;e<f;e+=1)c.push(this._treeLevels[e].treeItems);d=primitives.common.mergeSort(c,function(a){return b._treeItems[a].offset});c=0;g=a.width;e=0;for(f=d.length;e<f;e+=1)h=b._treeItems[d[e]],h.offset+c<g&&h.offset+h.actualSize.width+
...
primitives.orgdiagram.BaseController.prototype._setOffset=function(a){var b=this._treeLevels[a.level],c=this._itemsInterval[0===a.visibility?b.currentvisibility:a.visibility]/2,d,e,f,g,h,j;a.leftPadding=c+(0<b.currentOffset?c*a.relationDegree*this.options.cousinsIntervalMultiplier:0);a.rightPadding=c;a.offset=b.currentOffset+a.leftPadding;b.currentOffset=a.offset+a.actualSize.width+a.rightPadding;if(0<a.visualChildren.length){b=0;for(d=a.visualChildren.length;b<d;b+=1)this._setOffset(this._treeItems[a.visualChildren[b]]);
c=this._getChildrenOffset(a);if(0<c)this._offsetItemChildren(a,c);else if(0>c&&(c=-c,this._offsetItem(a,c),d=null,e={},g=null,h=this._getParentItem(a),null!==h)){for(b=h.visualChildren.length-1;0<=b;b-=1)if(j=h.visualChildren[b],j===a)d=[];else if(null!==d)if(f=this._getGapBetweenSiblings(j,a),e[j.id]=f,0<f)d.splice(0,0,j);else{g=j;break}if(0<d.length){if(null!==g){f=[g];f=f.concat(d);f.push(a);g=[[g]];b=1;for(d=f.length;b<d;b+=1)a=f[b-1],h=f[b],2==a.gravity||1==h.gravity?g[g.length-1].push(h):g.push([h])}else g=
[d.slice(0)],g[g.length-1].push(a);if(0<g.length){d=g[g.length-1];for(b=d.length-2;0<=b;b-=1)a=d[b],f=e[a.id],c=Math.min(f,c),this._offsetItem(a,c),this._offsetItemChildren(a,c)}h=c/(g.length-1);for(d=g.length-2;0<d;d-=1){j=g[d];for(b=j.length-1;0<=b;b-=1)a=j[b],f=e[a.id],c=Math.min(d*h,Math.min(f,c)),this._offsetItem(a,c),this._offsetItemChildren(a,c)}}}}};
...
primitives.orgdiagram.BaseController.prototype._readTemplates=function(){var a,b=new primitives.orgdiagram.TemplateConfig,c;this._templates={};a=new primitives.orgdiagram.Template(b,b);a.name=this.widgetEventPrefix+"Template";a.createDefaultTemplates(this.options);this._templates[a.name]=a;for(a=0;a<this.options.templates.length;a+=1)c=this.options.templates[a],c=new primitives.orgdiagram.Template(c,b),c.createDefaultTemplates(this.options),this._templates[c.name]=c};
...
primitives.orgdiagram.BaseController.prototype._onAnnotationLabelTemplateRender=function(a,b){b.element.html(b.context.label)};primitives.orgdiagram.BaseController.prototype._createPrintPreviewTemplate=function(){var a=jQuery("<div></div>");a.addClass("bp-item bp-printpreview");this._printPreviewTemplate=a.wrap("<div>").parent().html();this._printPreviewTemplateHashCode=primitives.common.hashCode(this._printPreviewTemplate)};primitives.orgdiagram.BaseController.prototype._createOrgTree=function(){};
...
this._orgItemRoot&&(a=this._getNewTreeItem({visibility:4,visualChildren:[],connectorPlacement:0,visualParentId:null,parentId:null,orgItem:this._orgItemRoot,itemConfig:null,actualItemType:0}),this._createVisualTreeItem(a),this._treeItemsByUserId.hasOwnProperty(this.options.cursorItem)&&(this._cursorTreeItem=this._treeItemsByUserId[this.options.cursorItem],this._cursorTreeItem.isCursor=!0),this._treeItemsByUserId.hasOwnProperty(this.options.highlightItem)&&(this._highlightTreeItem=this._treeItemsByUserId[this.options.highlightItem]),
this._readVisualTree(this._treeItems[this._visualRootItem],0),this._addExtraConnections(),this._showSelectedItems(),this._showCursorNeighbours(),this._debug))for(d in this._treeItems)if(this._treeItems.hasOwnProperty(d)){c=this._treeItems[d];a=0;for(b=c.logicalChildren.length;a<b;a+=1)if(e=c.logicalChildren[a],e=this._treeItems[e],f=!0,jQuery.each(e.logicalParents,function(a,b){if(b==d)return f=!1}),f)throw"Family tree is broken. Logical child does not reference logical parent.";}};
...
primitives.orgdiagram.BaseController.prototype._getNewTreeItem=function(a){var b=new primitives.orgdiagram.TreeItem(this._treeItemCounter),c;for(c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);this._treeItemCounter+=1;this._treeItems[b.id]=b;a=a.orgItem;null!=a&&(this._treeItemsByUserId[a.id]=b,template=this._templates[a.templateName],b.template=void 0!==template?template:this._defaultTemplate,b.actualHasSelectorCheckbox=this._getSelectionVisibility(this.options.cursorItem==a.id,a.hasSelectorCheckbox,this.options.hasSelectorCheckbox),
b.actualHasButtons=0<this.options.buttons.length&&this._getSelectionVisibility(this.options.cursorItem==a.id,a.hasButtons,this.options.hasButtons),b.actualIsActive=a.isActive&&b.template.isActive);return b};
primitives.orgdiagram.BaseController.prototype._createVisualTreeItem=function(a){var b,c,d,e,f,g,h,j,i,k;i=j=0;null!==a.visualParentId&&(i=this._treeItems[a.visualParentId].visualChildren,j=h=primitives.common.indexOf(i,a),i=i.length-h-1);g=[];f=this._orgItemChildren[a.orgItem.id];if(null!=f){h=0;for(e=f.length;h<e;h+=1)if(c=f[h],this.showInvisibleSubTrees||this._hasVisibleChildren(c)){b=this._getNewTreeItem({orgItem:c,itemConfig:c.context,parentId:a.id,visualParentId:a.id,actualItemType:c.itemType});
...
(i=this._getAdvisersDepth(a),1<i)){e=a;for(h=0;h<i-1;h+=1)e=this._createNewVisualAggregator(e)}f=[];h=0;for(e=c.length;h<e;h+=1){i=c[h];g=f[h]=0;for(j=i.length;g<j;g+=1)f[h]=Math.max(f[h],this._getItemDepth(i[g]))}h=0;for(e=f.length;h<e;h+=1)if(c=f[h],1<c){g=0;for(j=d[h].length;g<j;g+=1)if(k=d[h][g],0<k.visualChildren.length)for(i=c;1<i;)k=this._createNewVisualAggregator(k),i-=1}this._layoutPartners(a,b)};
primitives.orgdiagram.BaseController.prototype._layoutPartners=function(a,b){var c,d,e,f,g,h=0,j=[],i;f=[];if(1<b.length){d=this._getLastVisualAggregator(a);f=f.concat(d.visualChildren.slice(0));d=d.visualChildren.length=0;for(e=b.length;d<e;d+=1)c=b[d],g=this._getAdvisersDepth(c),c=this._getItemDepth(c),h=Math.max(Math.max(h,c),g);d=0;for(e=b.length;d<e;d+=1){c=b[d];i=this._getLastVisualAggregator(c);for(c=this._getLastVisualAggregatorDepth(c);c<h;)i=this._createNewVisualAggregator(i),c+=1;j.push(this._getLastVisualAggregator(i).id)}if(0<
f.length){i=b[Math.floor(b.length/2)];if(1<b.length&&0==b.length%2){d=this._treeItems[i.visualParentId];e=this._findLeftSiblingIndex(d.visualChildren,i);c=d.visualChildren[e].gravity||d.visualChildren[e+1].gravity;i=this._getNewTreeItem({visibility:4,visualParentId:d.id,connectorPlacement:i.connectorPlacement&10,gravity:c});d.visualChildren.splice(e+1,0,i);for(c=1;c<h;)i=this._createNewVisualAggregator(i),i.connectorPlacement=0,c+=1}i=this._getLastVisualAggregator(i);i.visualChildren=f;d=0;for(e=
f.length;d<e;d+=1)h=f[d],h.visualParentId=i.id;d=0;for(e=b.length;d<e;d+=1)if(c=b[d],c.id!=a.id){f=0;for(g=a.logicalChildren.length;f<g;f+=1)switch(h=a.logicalChildren[f],h.actualItemType){case 5:case 2:case 4:case 1:break;default:this._defineLogicalParent(c,h)}}}i.partners=j}};primitives.orgdiagram.BaseController.prototype._defineLogicalParent=function(){};
...
primitives.orgdiagram.BaseController.prototype._layoutChildren=function(a,b,c,d){var e,f,g,h,j,i,k,l,n,m=4==a.visibility&&0==a.connectorPlacement;switch(this.options.horizontalAlignment){case 0:case 1:f=3;break;case 2:f=2}0===b&&(b=this._hasLeavesOnly(a)?0===this.options.leavesPlacementType?3:this.options.leavesPlacementType:0===this.options.childrenPlacementType?2:this.options.childrenPlacementType);e=a;null!==a.visualAggregatorId&&(e=this._treeItems[a.visualAggregatorId]);switch(b){case 2:0<e.visualChildren.length&&
(this._treeItems[e.visualChildren[0]].relationDegree=1);break;case 3:if(3<e.visualChildren.length){a=e.visualChildren.slice(0);e.visualChildren.length=0;j=Math.min(this.options.maximumColumnsInMatrix,Math.ceil(Math.sqrt(a.length)));i=Math.ceil(a.length/j);k=Math.ceil(j/2);for(l=0;l<k;l+=1){f=e;for(n=0;n<i;n+=1){b=this._getMatrixItem(a,2*l,n,j);g=this._getMatrixItem(a,2*l+1,n,j);void 0===c[n]&&(c[n]=[],d[n]=[]);null!==b&&(0==l&&(b.relationDegree=1),f.visualChildren.push(b),b.visualParentId=f.id,b.connectorPlacement=
(m?0:2)|4,b.gravity=2,d[n].push(b));if(null!==b||null!==g)h=this._getNewTreeItem({visibility:4,visualParentId:f.id,connectorPlacement:m?0:5}),f.visualChildren.push(h),f.visualAggregatorId=h.id,c[n].push(h);null!==g&&(f.visualChildren.push(g),g.visualParentId=f.id,g.connectorPlacement=(m?0:8)|4,g.gravity=1,d[n].push(g));f=h}}2<j&&(e.visualAggregatorId=null)}break;case 1:a=e.visualChildren.slice(0);g=e.visualChildren.length=0;for(j=a.length;g<j;g+=1){b=a[g];h=this._getNewTreeItem({visibility:4,visualParentId:e.id,
connectorPlacement:m?0:5});e.visualAggregatorId=h.id;b.visualParentId=e.id;switch(f){case 2:e.visualChildren.push(b);e.visualChildren.push(h);b.connectorPlacement=(m?0:2)|4;b.gravity=2;break;case 3:e.visualChildren.push(h),e.visualChildren.push(b),b.connectorPlacement=(m?0:8)|4,b.gravity=1}c[g]=[h];d[g]=[b];e=h}}};primitives.orgdiagram.BaseController.prototype._getMatrixItem=function(a,b,c,d){0<d%2&&(b===d-1?b=a.length:b===d&&(b=d-1));b=c*d+b;return b>a.length-1?null:a[b]};
...
primitives.orgdiagram.BaseController.prototype._createNewVisualAggregator=function(a){var b,c;b=this._getNewTreeItem({visibility:4,visualParentId:a.id,visualAggregatorId:a.visualAggregatorId,connectorPlacement:4==a.visibility&&0==a.connectorPlacement?0:5});b.visualChildren=a.visualChildren;for(c=0;c<b.visualChildren.length;c+=1)b.visualChildren[c].visualParentId=b.id;a.visualChildren=[b];a.visualAggregatorId=b.id;return b};
primitives.orgdiagram.BaseController.prototype._readVisualTree=function(a,b){var c=this._treeLevels[b],d,e;void 0===c&&(c=this._treeLevels[b]=new primitives.orgdiagram.TreeLevel(b));c.treeItems.push(a.id);a.actualIsActive&&4!=a.visibility&&c.activeTreeItems.push(a.id);a.level=b;a.levelPosition=c.treeItems.length-1;c=0;for(d=a.visualChildren.length;c<d;c+=1)e=a.visualChildren[c],0===c&&this._updateLeftMargins(e,0),c===d-1&&this._updateRightMargins(e,0),this._readVisualTree(e,b+1)};
primitives.orgdiagram.BaseController.prototype._updateLeftMargins=function(a,b){for(var c=a,d;null!==(c=this._getParentItem(c));)d=this._leftMargins[c.id],void 0===d&&(d=this._leftMargins[c.id]=[]),void 0===d[b]&&(d[b]=a.id),b+=1};primitives.orgdiagram.BaseController.prototype._updateRightMargins=function(a,b){for(var c=a,d;null!==(c=this._getParentItem(c));)d=this._rightMargins[c.id],void 0===d&&(d=this._rightMargins[c.id]=[]),d[b]=a.id,b+=1};
...
primitives.common.SharedReferences=function(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)};primitives.common.StackSegment=function(a,b,c){this.context=a;this.startIndex=b;this.endIndex=c};primitives.common.StackSegment.prototype.toString=function(){return"["+Math.round(this.startIndex)+" - "+Math.round(this.endIndex)+"]"};
primitives.common.getGraphSpanningTree=function(a,b,c){var d={},e={},f,g=[],h={},j,i,k,l,n,m,p;e[b]=!0;j=1;for(h[b]=null;0<j;){g=[];l=k=i=null;for(f in e)if(e.hasOwnProperty(f)){n=a[f];b=!1;for(m in n)if(n.hasOwnProperty(m)&&!h.hasOwnProperty(m)&&(p=n[m],b=!0,!k||0<=c(p,k)))i=m,k=p,l=f;b||g.push(f)}if(null==i)break;else e[i]=!0,j+=1,h[i]=l,d.hasOwnProperty(l)||(d[l]=[]),d[l].push(i);b=0;for(i=g.length;b<i;b+=1)delete e[g[b]],j-=1}return d};
primitives.common.getShortestPath=function(a,b,c){var d={},e={},f={},g,h,j,i,k;d[b]=!0;g=1;for(e[b]=0;0<g;){h=b=null;for(j in d)d.hasOwnProperty(j)&&(null==h?(b=j,h=e[j]):h>e[j]&&(b=j,h=e[j]));i=a[b];for(j in i)i.hasOwnProperty(j)&&(k=h+1,e.hasOwnProperty(j)?e[j]>k&&d.hasOwnProperty(j)&&(e[j]=k,f[j]=b):(e[j]=k,f[j]=b,d[j]=!0,g+=1));if(b==c)break;else delete d[b],g-=1}for(a=[];null!=c;)a.push(c),c=f[c];return a};
...
primitives.common.optimizeReferences=function(a,b){var c={},d=[],e={},f={},g,h,j,i,k,l,n,m,p,q,r;for(g in a)a.hasOwnProperty(g)&&(h=a[g],j=new primitives.common.ReferenceItem,h.sort(),j.key=h.join(","),j.name=g,j.targets=h.slice(0),j.actualTargets=h.slice(0),j.level=0,f[j.name]=j);for(;!primitives.common.isEmptyObject(f);){h={};j=primitives.common.getReferencesGraph(f);for(g in f)if(f.hasOwnProperty(g)&&(i=f[g],d.push(i),!i.processed))for(n in l=primitives.common.getGraphSpanningTree(j,g,function(a,
b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),l)if(l.hasOwnProperty(n)){f[n].processed=!0;m=l[n];i=0;for(k=m.length;i<k;i+=1)p=m[i],f[p].processed=!0,q=j[n][p],1<q.weight&&(g=q.items.join(","),r=null,e.hasOwnProperty(g)?r=e[g]:(r=new primitives.common.ReferenceItem,r.name=b(),r.key=g,r.actualTargets=q.items.slice(0),r.targets=q.items.slice(0),e[r.key]=r,h[r.name]=r),primitives.common.addGroup(f[n],r),primitives.common.addGroup(f[p],r))}f=h}i=0;for(k=d.length;i<k;i+=
...
primitives.common.getReferencesGraph=function(a){var b={},c=primitives.common.invertReferences(a,function(a){return a.targets}),d,e,f,g,h,j,i,k,l;for(d in c)if(c.hasOwnProperty(d)){e=c[d];f=0;for(h=e.length;f<h-1;f+=1){j=e[f];i=a[j];for(g=f+1;g<h;g+=1)k=e[g],l=a[k],l=Math.abs(i.targets.length-l.targets.length),b.hasOwnProperty(j)||(b[j]={}),b[j].hasOwnProperty(k)||(b[j][k]=new primitives.common.SharedReferences(l)),b[j][k].items.push(d),b[j][k].weight+=1,b.hasOwnProperty(k)||(b[k]={}),b[k].hasOwnProperty(j)||
(b[k][j]=new primitives.common.SharedReferences(l)),b[k][j].items.push(d),b[k][j].weight+=1}}return b};
primitives.common.topologicalSort=function(a){var b=[],c={},d,e,f,g,h,j,i,k;for(d in a)if(a.hasOwnProperty(d)){e=a[d];g=0;for(h=e.length;g<h;g+=1)j=e[g].toString(),c.hasOwnProperty(j)||(c[j]=0),c[j]+=1}j=[];for(d in a)a.hasOwnProperty(d)&&(c.hasOwnProperty(d)||j.push(d));for(;0<j.length;){d=[];g=0;for(h=j.length;g<h;g+=1){e=j[g];b.push(e);e=a[e];i=0;for(k=e.length;i<k;i+=1)f=e[i].toString(),c[f]-=1,0==c[f]&&d.push(f)}j=d}return b};
primitives.common.getGraphGrowthSequence=function(a,b,c){var d=[b],e={},f,g=[],h={},j,i,k,l,n,m,p;e[b]=!0;j=1;for(h[b]=null;0<j;){g=[];k=i=null;l={};for(f in e)if(e.hasOwnProperty(f)){n=a[f];b=!1;for(m in n)if(n.hasOwnProperty(m)&&!h.hasOwnProperty(m)&&(p=c(n[m]),b=!0,null==l[m]&&(l[m]=0),l[m]+=p,!k||l[m]>k))i=m,k=l[m];b||g.push(f)}if(null==i)break;else e[i]=!0,j+=1,h[i]=!0,d.push(i);b=0;for(i=g.length;b<i;b+=1)delete e[g[b]],j-=1}return d};
primitives.common.mergeSort=function(a,b){var c=null,d,e,f,g,h,j,i,k,l,n,m;switch(a.length){case 0:c=[];break;case 1:c=a[0].slice(0);break;default:c=a[0];for(f=1;f<a.length;f+=1){d=a[f];e=[];j=c.length;i=d.length;h=g=0;m=l=n=k=null;0<j&&(k=c[g],n=!b?k:b(k));0<i&&(l=d[h],m=!b?l:b(l));for(;g<j||h<i;)g>=j?(e.push(l),h+=1,h<i&&(l=d[h],m=!b?l:b(l))):h>=i?(e.push(k),g+=1,g<j&&(k=c[g],n=!b?k:b(k))):n<m?(e.push(k),g+=1,g<j&&(k=c[g],n=!b?k:b(k))):(e.push(l),h+=1,h<i&&(l=d[h],m=!b?l:b(l)));c=e}}return c};
primitives.common.stackSegments=function(a,b){var c=0,d,e,f,g,h,j,i,k=[],l,n,m,p,q,r,s={};a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});g=0;for(h=a.length;g<h;g+=1){f=a[g];e=d=0;m=f.startIndex;s[m]=d+1;p=f.endIndex;s[p]=e;i=k.length;if(0<i){l=[];r=q=!1;for(j=0;j<i;j+=1)n=k[j],n<m?(l.push(n),d=s[n],e=s[n]):n<p?(q||(l.push(m),q=!0),d=Math.max(d,s[n]),e=s[n]):(q||(l.push(m),q=!0),r||(l.push(p),r=!0,s[m]=d+1,s[p]=e),l.push(n));q||(l.push(m),q=!0);r||(l.push(p),r=!0,s[m]=
d+1,s[p]=e);k=l}else k=[m,p];b(f,s[m]);c=Math.max(c,s[m])}return c};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,j;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),j=a[g],d=b(j),0<=d)c=j;else{d=Math.abs(d);e>d&&(e=d,c=j);for(;f+1<g;)if(h=Math.round((f+g)/2),j=a[h],d=b(j),0==d){c=j;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=j)}return c};
...
primitives.famdiagram.Controller.prototype._getEventArgs=function(a,b,c){var d=new primitives.famdiagram.EventArgs,e,f;null!=a&&(a.itemConfig&&null!=a.itemConfig.id)&&(d.oldContext=this._treeItemConfigs[a.itemConfig.id]);if(null!=b&&b.itemConfig&&null!=b.itemConfig.id){d.context=this._treeItemConfigs[b.itemConfig.id];if(null!=b.itemConfig.parents){a=0;for(e=b.itemConfig.parents.length;a<e;a+=1)f=this._treeItemConfigs[b.itemConfig.parents[a]],null!=f&&d.parentItems.push(f)}e=this.m_placeholder.offset();
a=this.element.offset();d.position=(new primitives.common.Rect(b.actualPosition)).translate(e.left,e.top).translate(-a.left,-a.top)}null!=c&&(d.name=c);return d};
primitives.famdiagram.Controller.prototype._createOrgTree=function(){var a,b,c,d,e,f,g,h={},j;g=[];var i,k,l,n,m=this;this.showElbowDots=this.showInvisibleSubTrees=!0;this._treeItemConfigs={};this._famItems={};this._famItemsNonExtracted={};this.itemByChildrenKey={};this._orgPartners={};this._families=[];this._orgItems={};this._orgItemChildren={};this._orgItemRoot=null;this.maximumFamItemId=0;this.maximumLevel=this.minimumLevel=null;if(0<this.options.items.length){a=0;for(b=this.options.items.length;a<
b;a+=1)d=this.options.items[a],null!=d&&(this._treeItemConfigs[d.id]=d,g=new primitives.famdiagram.FamilyItem,g.id=d.id,g.itemConfig=d,this._famItems[g.id]=g,g=parseInt(d.id,10),this.maximumFamItemId=Math.max(isNaN(g)?0:g,this.maximumFamItemId));for(k in this._famItems)if(this._famItems.hasOwnProperty(k)&&(g=this._famItems[k],i={},j=g.itemConfig.parents,null!=j)){a=0;for(b=j.length;a<b;a+=1)d=j[a],this._famItems.hasOwnProperty(d)&&(d!=g.id&&!i.hasOwnProperty(d))&&(g.parents.push(d),this._famItems[d].logicalChildren.push(g.id),
this._famItems[d].children.push(g.id),i[d]=!0)}this._setLogicalParents(this._famItems);this._sortItemsBylevels2(this._famItems);for(c in this._famItems)this._famItems.hasOwnProperty(c)&&(g=this._famItems[c],g.level2=g.level,g.level=null);for(c in this._famItems)this._famItems.hasOwnProperty(c)&&(g=this._famItems[c],g.logicalChildren.sort(function(a,b){return m._famItems[a].level2-m._famItems[b].level2}),g.logicalParents.sort(function(a,b){return m._famItems[b].level2-m._famItems[a].level2}));this._sortItemsBylevels(this._famItems);
a={};for(c in this._famItems)this._famItems.hasOwnProperty(c)&&(a[c]=this._famItems[c].logicalChildren.slice(0));a=primitives.common.optimizeReferences(a,function(){var a;m.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem;a.isVisible=!1;a.id=m.maximumFamItemId;m._famItems[a.id]=a;return a.id});for(c in a)a.hasOwnProperty(c)&&(k=a[c],m._famItems[c].logicalChildren=k);this._eliminateManyToMany(this._famItems,function(){var a;m.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem;a.isVisible=
!1;a.itemConfig=new primitives.famdiagram.ItemConfig({id:m.maximumFamItemId});a.id=m.maximumFamItemId;return a});this._resortItemsBylevels(this._famItems);this._fillInItems(this._famItems,function(){var a;m.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem;a.isVisible=!1;a.id=m.maximumFamItemId;return a});for(c in this._famItems)this._famItems.hasOwnProperty(c)&&(g=this._famItems[c],g.logicalParents=[]);this._setLogicalParents(this._famItems);if(this._debug)for(c in this._famItems)if(this._famItems.hasOwnProperty(c)){g=
this._famItems[c];k=g.logicalChildren;for(a=0;a<k.length;a+=1){b=k[a];b=this._famItems[b];if(0>b.logicalParents.indexOf(c))throw"Family tree is broken. Logical child does not reference logical parent.";if(null===b.level||null===g.level||b.level!=g.level+1)throw"Family tree is broken. Children/Parents or levels mismatch!";}}this._famItemsNonExtracted={};for(c in this._famItems)this._famItems.hasOwnProperty(c)&&(this._famItemsNonExtracted[c]=this._famItems[c]);this.properties="title description image itemTitleColor groupTitle groupTitleColor isVisible isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");
this.defaultItemConfig=new primitives.famdiagram.ItemConfig;a=null;for(b=0;null!=(a=this._findLargestRoot());)k=new primitives.famdiagram.Family(b),this._extractOrgChart(k,this._famItems[a]),this._families.push(k),b+=1;g=[];i={};if(0<this._families.length){a=0;for(b=this._families.length;a<b;a+=1){k=this._families[a];c=0;for(d=k.links.length;c<d;c+=1)j=k.links[c],e=this._famItems[j.fromItem].familyId,f=this._famItems[j.toItem].familyId,e!=f&&(h.hasOwnProperty(e)||(h[e]={}),h[e].hasOwnProperty(f)||
(h[e][f]=0),h[e][f]+=1,h.hasOwnProperty(f)||(h[f]={}),h[f].hasOwnProperty(e)||(h[f][e]=0),h[f][e]+=1),this._families[f].backLinks.push(new primitives.famdiagram.FamLink(j.toItem,j.fromItem))}for(;g.length<this._families.length;){a=0;for(b=this._families.length;a<b;a+=1)if(k=this._families[a],!i.hasOwnProperty(k.id))if(j=primitives.common.getGraphSpanningTree(h,k.id,function(a,b){return a-b}),j.hasOwnProperty(k.id)){this._countNumberOfSubFamilies(k.id,j);g.push(k.id);i[k.id]=!0;k=j[k.id];c=0;for(d=
k.length;c<d;c+=1){l=this._getFamilyAndItsSubFamilies(k[c],j);e=0;for(f=l.length;e<f;e+=1)n=l[e],g.push(n),i[n]=!0}}else g.push(k.id),i[k.id]=!0}}this.maximumFamItemId+=1;this._orgItemRoot=this._createOrgItem(this.maximumFamItemId,null,null,this.minimumLevel-1,null);this._orgItemRoot.hideParentConnection=!0;this._orgItemRoot.hideChildrenConnection=!0;this._orgItemRoot.title="internal root";this._orgItemRoot.isVisible=!1;d={};a=0;for(b=g.length;a<b;a+=1){k=this._families[g[a]];i={};e=this._orgItemRoot;
f=0;h=k.links.concat(k.backLinks);for(c=0;c<h.length;c+=1)if(j=h[c],l=this._orgItems[j.toItem],!0==d[l.familyId]){for(j=k.items[0];l.level>=j.level;)l=this._orgItems[l.parent];i[l.id]=i.hasOwnProperty(l.id)?i[l.id]+1:1;f<i[l.id]&&(e=l,f=i[l.id])}this._attachFamilyToOrgChart(e,k);d[k.id]=!0}a=this._getExtraGravity();b=this._getGrandChildren();this._balanceChildrenForItem(a,b,this._orgItemRoot)}};
...
primitives.famdiagram.Controller.prototype._balanceChildrenForItem=function(a,b,c){var d,e,f,g,h,j,i,k,l,n,m,p=[c],q,r=[],s,t,v,w,u;for(c.childIndex=0;0<p.length;){c=0;for(i=p.length;c<i;c+=1)if(q=p[c],d={},e={},this._orgItemChildren.hasOwnProperty(q.id)){t=this._orgItemChildren[q.id];l=null;s=[];if(0<t.length){f=0;for(g=t.length;f<g;f+=1){k=t[f];null==l&&(l=k);e[k.id]={};if(a.hasOwnProperty(k.id))for(w in m=a[k.id],m)if(m.hasOwnProperty(w)){u=m[w];e[k.id][w]={};h=0;for(j=u.length;h<j;h+=1)n=u[h],
n=n.commonParent==q.id?n.toParent:this._orgItems[n.fromParent].childIndex<this._orgItems[n.toParent].childIndex?"__right__":"__left__",k.id!=n&&(d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(n)||(d[k.id][n]=0),d[k.id][n]+=1,null==e[k.id][w][n]&&(e[k.id][w][n]=0),e[k.id][w][n]+=1)}0<f&&(d.hasOwnProperty(l.id)||(d[l.id]={}),d[l.id].hasOwnProperty(k.id)||(d[l.id][k.id]=0),d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(l.id)||(d[k.id][l.id]=0))}if(null!=l){f=0;l=l.id;for(v in d)if(d.hasOwnProperty(v)){g=
d[v];h=0;for(n in g)g.hasOwnProperty(n)&&(h+=g[n]);h>f&&(l=v,f=h)}d=primitives.common.getGraphGrowthSequence(d,l,function(a){return a});l=this._balanceItems(d,"__left__","__right__",e,b);e=0;for(d=l.length;e<d;e+=1)f=this._orgItems[l[e]],f.childIndex=e,s.push(f)}if(this._debug&&!primitives.common.compareArrays(this._orgItemChildren[q.id],s,function(a){return a.id}))throw"Balancing of items is broken! Incoming vs. outgoing arrays of items mismatch.";this._orgItemChildren[q.id]=s}r=r.concat(t)}p=r;
r=[]}};
primitives.famdiagram.Controller.prototype._balanceItems=function(a,b,c,d,e){var f=[],g,h,j,i,k,l,n,m,p,q,r,s,t,v,w,u,x,z,A,y;h=new primitives.famdiagram.Slots;h.add(new primitives.famdiagram.Slot(b));h.add(new primitives.famdiagram.Slot(null));h.add(new primitives.famdiagram.Slot(c));j=0;h.loop(function(a){j+=1;a.position=j});for(g=0;g<a.length;g+=1)if(i=a[g],i!=b&&i!=c)for(x in p=m=n=l=k=null,h.loop(function(a){var b,c,f,g;if(null==a.itemId){v=e[i];t=s=r=q=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(v&&
null!=v[b]&&(q+=a.crossings[b]*v[b]),t+=a.crossings[b]);for(b in d[i])if(d[i].hasOwnProperty(b))for(c in f=d[i][b],f)f.hasOwnProperty(c)&&(g=h.getSlot(c),null!=g&&(g.position<a.position?(q+=(a.left[b]||0)-(g.left[b]||0),s+=Math.abs(g.balance+1)):(q+=(a.right[b]||0)-(g.right[b]||0),s+=Math.abs(g.balance-1)),r+=Math.abs(g.position-a.position)));if(null==l||l>q||l==q&&(n>r||n==r&&(m>s||m==s&&p>t)))l=q,k=a,n=r,m=s,p=t}}),w=k.clone(),u=k.clone(),u.itemId=i,h.insertBefore(k,w),h.insertBefore(k,u),j=u.position=
0,h.loop(function(a){var b,c;if(a.id!=u.id){c=e[i];for(b in c)c.hasOwnProperty(b)&&(a.left[b]=a.left[b]?a.left[b]+c[b]:c[b]);j+=1;a.position=j}},u),j=0,h.backwardLoop(function(a){var b,c;if(a.id!=u.id){c=e[i];for(b in e[i])e[i].hasOwnProperty(b)&&(a.right[b]=a.right[b]?a.right[b]+c[b]:c[b]);j-=1;a.position=j}},u),d[i])if(d[i].hasOwnProperty(x))for(A in z=d[i][x],z)z.hasOwnProperty(A)&&(y=h.getSlot(A),null!=y&&(0>y.position?(y.balance+=1,u.balance-=1,h.backwardLoop(function(a){if(a.id!=u.id)if(a.id!=
...
primitives.famdiagram.Controller.prototype._sortItemBylevels=function(a,b,c){for(var d,e,f,g,h,j=this._getParentEdges(a,c),i=this._getChildrenEdges(a,c);0<j.length||0<i.length;){g=[];h=[];a=0;for(d=i.length;a<d;a+=1)e=b[i[a].parent],f=b[i[a].child],null==f.level?(f.level=this._getMaximumLevel(f.logicalParents,b)+1,g=g.concat(this._getParentEdges(f,c)),h=h.concat(this._getChildrenEdges(f,c))):f.level<=e.level&&this._shiftChartItem(f,e.level-f.level+1,b);a=0;for(d=j.length;a<d;a+=1)e=b[j[a].parent],
f=b[j[a].child],null==e.level?(e.level=this._getMinimumLevel(e.logicalChildren,b)-1,g=g.concat(this._getParentEdges(e,c)),h=h.concat(this._getChildrenEdges(e,c))):f.level<=e.level&&this._shiftChartItem(f,e.level-f.level+1,b);j=g;i=h}};primitives.famdiagram.Controller.prototype._getParentEdges=function(a,b){var c,d,e,f=[],g;c=0;for(d=a.logicalParents.length;c<d;c+=1)e=a.logicalParents[c],g=e+","+a.id,b.hasOwnProperty(g)||(f.push(new primitives.famdiagram.EdgeItem(e,a.id)),b[g]=!0);return f};
...
primitives.famdiagram.Controller.prototype._setLevelsForItems=function(a,b,c,d){for(var e=c,f,g,h,j,i,k,l;!primitives.common.isEmptyObject(a);){f={};for(g in a)if(a.hasOwnProperty(g)){h=a[g];null==h.level&&(h.level=c);j=0;for(i=h.logicalChildren.length;j<i;j+=1)k=h.logicalChildren[j],l=b[k],null==l.originalLevel?(l.level=null==l.level?h.level+1:Math.max(l.level,h.level+1),f[k]=l):l.originalLevel==d&&(e=Math.max(e,h.level+1))}a=f}return e};
primitives.famdiagram.Controller.prototype._fillInItems=function(a,b){var c=[],d,e,f,g,h,j,i,k;for(d in a)if(a.hasOwnProperty(d)){e=a[d];for(f=!0;f;){f=!1;h=[];j=[];i=0;for(k=e.logicalChildren.length;i<k;i+=1)g=a[e.logicalChildren[i]],e.level+1<g.level?j.push(g.id):h.push(g.id);0<j.length&&(g=b(),g.level=e.level+1,g.logicalChildren=j,h.push(g.id),e.logicalChildren=h,f=!0,e=g,c.push(g))}}for(d=0;d<c.length;d+=1)g=c[d],a[g.id]=g};
...
primitives.famdiagram.Controller.prototype._eliminateManyToMany=function(a,b){var c=[],d={},e,f,g,h,j,i,k;for(e in a)if(a.hasOwnProperty(e)){i=a[e];f=0;for(g=i.logicalChildren.length;f<g;f+=1)h=i.logicalChildren[f],d.hasOwnProperty(h)||(d[h]=[]),d[h].push(e)}for(e in a)if(a.hasOwnProperty(e)&&(i=a[e],1<i.logicalChildren.length)){k=[];f=0;for(g=i.logicalChildren.length;f<g;f+=1)h=i.logicalChildren[f],1<d[h].length?(j=b(),j.logicalChildren=[h],k.push(j.id),c.push(j)):k.push(h);i.logicalChildren=k}for(d=
0;d<c.length;d+=1)j=c[d],a[j.id]=j};
primitives.famdiagram.Controller.prototype._showCursorNeighbours=function(){var a,b,c,d,e,f;if(null!==this._cursorTreeItem&&(0===this._cursorTreeItem.visibility&&(this._cursorTreeItem.visibility=1),null!=this._cursorTreeItem.itemConfig)){e=this._famItems[this._cursorTreeItem.itemConfig.id];f=[];for(b=e.children.slice(0);0<b.length;){f=f.concat(b);d=[];for(a=0;a<b.length;a+=1)c=this._famItems[b[a]],orgItem=this._orgItems[b[a]],orgItem.isActive||(d=d.concat(c.children)),f=f.concat(c.parents);b=d}for(b=
e.parents.slice(0);0<b.length;){f=f.concat(b);d=[];for(a=0;a<b.length;a+=1)c=this._famItems[b[a]],orgItem=this._orgItems[b[a]],orgItem.isActive||(d=d.concat(c.parents)),f=f.concat(c.children);b=d}for(a=0;a<f.length;a+=1)b=this._treeItemsByUserId[f[a]],0===b.visibility&&(b.visibility=1)}};primitives.famdiagram.EdgeItem=function(a,b){this.child=this.parent=null;switch(arguments.length){case 2:this.parent=a,this.child=b}};
primitives.famdiagram.EdgeItem.prototype.toString=function(){return this.parent+","+this.child};primitives.famdiagram.ExtraGravity=function(a){this.toParent=this.fromParent=this.commonParent=null;this.level=a};primitives.famdiagram.Family=function(a){this.familyPriority=this.id=null;this.items=[];this.links=[];this.backLinks=[];1==arguments.length&&(this.id=a)};
...
primitives.orgdiagram.Controller.prototype._getEventArgs=function(a,b,c){var d=new primitives.orgdiagram.EventArgs,e;null!=a&&(a.itemConfig&&null!=a.itemConfig.id)&&(d.oldContext=this._treeItemConfigs[a.itemConfig.id]);null!=b&&(b.itemConfig&&null!=b.itemConfig.id)&&(d.context=this._treeItemConfigs[b.itemConfig.id],null!==b.itemConfig.parent&&(d.parentItem=this._treeItemConfigs[b.itemConfig.parent]),e=this.m_placeholder.offset(),a=this.element.offset(),d.position=(new primitives.common.Rect(b.actualPosition)).translate(e.left,
e.top).translate(-a.left,-a.top));null!=c&&(d.name=c);return d};
primitives.orgdiagram.Controller.prototype._createOrgTree=function(){var a,b,c,d,e,f,g,h,j,i,k;this._treeItemConfigs={};this._orgItems={};this._orgItemChildren={};this._orgItemRoot=null;if(null!=this.options.items&&0<this.options.items.length){h="title description image itemTitleColor groupTitle groupTitleColor isVisible isActive hasSelectorCheckbox hasButtons itemType adviserPlacementType childrenPlacementType templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");j=
new primitives.orgdiagram.ItemConfig;i=0;k=[];c=0;for(d=this.options.items.length;c<d;c+=1)if(b=this.options.items[c],null!=b.id){this._treeItemConfigs[b.id]=b;a=new primitives.orgdiagram.OrgItem;a.id=b.id;a.parent=b.parent;e=parseInt(b.id,10);i=Math.max(isNaN(e)?0:e,i);a.context=b;e=0;for(f=h.length;e<f;e+=1)g=h[e],a[g]=void 0!==b[g]?b[g]:j[g];this._orgItems[a.id]=a;this._orgItemChildren.hasOwnProperty(a.parent)?this._orgItemChildren[a.parent].push(a):this._orgItemChildren[a.parent]=[a];null==a.parent&&
(k.push(a),a.itemType=0)}i+=1;this._orgItemRoot=new primitives.orgdiagram.OrgItem;this._orgItemRoot.id=i;this._orgItemRoot.hideParentConnection=!0;this._orgItemRoot.hideChildrenConnection=!0;this._orgItemRoot.title="internal root";this._orgItemRoot.isVisible=!1;this._orgItems[this._orgItemRoot.id]=this._orgItemRoot;this._orgItemChildren[this._orgItemRoot.id]=k;this._hideRootConnectors([this._orgItemRoot])}};
primitives.orgdiagram.Controller.prototype._hideRootConnectors=function(a){for(var b,c,d,e,f,g,h,j,i;0<a.length;){b=[];c=0;for(d=a.length;c<d;c+=1)if(g=a[c],!g.isVisible&&this._orgItemChildren.hasOwnProperty(g.id)){h=this._orgItemChildren[g.id];i=!0;e=0;for(f=h.length;e<f;e+=1)if(j=h[e],0!=j.itemType){i=!1;break}if(i){g.hideChildrenConnection=!0;e=0;for(f=h.length;e<f;e+=1)j=h[e],j.hideParentConnection=!0,j.isVisible||b.push(j)}}a=b}};
primitives.orgdiagram.Controller.prototype._defineLogicalParent=function(a,b){var c={},d,e={},f={},g,h,j;if(!a.actualIsActive||4==a.visibility){for(j=0;j<a.logicalParents.length;j+=1)d=a.logicalParents[j],e[d]=!0;for(;!primitives.common.isEmptyObject(e);){for(h in e)if(e.hasOwnProperty(h))if(d=this._treeItems[h],!d.actualIsActive||4==d.visibility){g=d.logicalParents;for(j=0;j<g.length;j+=1)d=g[j],f[d]=!0}else c[d.id]=d;e=f;f={}}}primitives.common.isEmptyObject(c)&&(c[a.id]=a);for(h in c)if(c.hasOwnProperty(h)){d=
c[h];if(this._debug&&0<primitives.common.indexOf(d.logicalChildren,b,function(a,b){return a.id==b.id}))throw"Duplicate value in logical logicalChildren array.";d.logicalChildren.push(b);if(this._debug&&0<primitives.common.indexOf(b.logicalParents,d.id))throw"Duplicate value in logical parents array.";b.logicalParents.push(h)}};
...
primitives.orgdiagram.ConnectorPoint=function(){this.parent=primitives.common.Point.prototype;this.parent.constructor.apply(this,arguments);this.hasElbow=!1;this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;this.highlightPath=0;this.connectorStyleType=1};primitives.orgdiagram.ConnectorPoint.prototype=new primitives.common.Point;primitives.orgdiagram.LevelVisibility=function(a,b){this.level=a;this.currentvisibility=b};
primitives.orgdiagram.OrgItem=function(){this.image=this.description=this.title=this.context=this.parent=this.id=null;this.itemTitleColor="#4169e1";this.groupTitle=null;this.groupTitleColor="#4169e1";this.isActive=this.isVisible=!0;this.childrenPlacementType=this.adviserPlacementType=this.itemType=this.hasButtons=this.hasSelectorCheckbox=0;this.templateName=null;this.showCallout=0;this.label=this.calloutTemplateName=null;this.showLabel=0;this.labelSize=null;this.labelOrientation=3;this.labelPlacement=
0;this.level=null;this.hideChildrenConnection=this.hideParentConnection=!1;this.childIndex=null};primitives.orgdiagram.Polyline=function(a,b,c){var d;this.lineColor="#c0c0c0";this.lineWidth=1;this.lineType=0;this.segments=[];switch(arguments.length){case 1:for(d in a)a.hasOwnProperty(d)&&(this[d]=a[d]);break;case 3:this.lineColor=a,this.lineWidth=b,this.lineType=c}};primitives.orgdiagram.Polyline.prototype.toString=function(){return this.lineColor+"."+this.lineWidth+"."+this.lineType};
...
this.actualHasButtons=this.actualHasSelectorCheckbox=this.actualIsActive=this.isSelected=this.isCursor=!1;this.actualItemType=null;this.relationDegree=this.partnerHighlightPath=this.highlightPath=this.gravity=this.connectorPlacement=0};
...
primitives.orgdiagram.TreeItem.prototype.toString=function(){return this.id};primitives.orgdiagram.TreeLevel=function(a){this.level=a;this.actualVisibility=this.currentvisibility=1;this.partnerConnectorOffset=this.levelSpace=this.connectorShift=this.topConnectorShift=this.currentOffset=this.nextLevelShift=this.depth=this.shift=0;this.treeItems=[];this.activeTreeItems=[];this.labels=[];this.labelsRect=null;this.showLabels=!0;this.hasFixedLabels=!1};
primitives.orgdiagram.TreeLevel.prototype.shiftDown=function(a){this.topConnectorShift+=a;this.connectorShift+=a;this.nextLevelShift+=a;this.shift+=a};primitives.orgdiagram.TreeLevel.prototype.toString=function(){return this.level+"."+this.currentvisibility};(function(a){a.widget("ui.orgDiagram",jQuery.ui.mouse2,new primitives.orgdiagram.Controller)})(jQuery);
