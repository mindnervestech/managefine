	...
	<div class="tsMainDiv">
		...
		<div class="worksheetDiv container">
			...
			<div class="twipsies well timesheetRow" style="width: 100%;margin-left: 0%;" ng-repeat="row in timesheetData track by $index" on-finish-render="ngRepeatFinished">
					...
					<div id="timesheetRowsfield" class="innerChainSelect">
						...
						<div class="clearfix"
							...
							<div class="input" ng-init="setTaskOfProject(row.projectCode,$index)">
								...
								<!-- <a  type="button" disabled  class="remove btn danger pull-right" ng-show="isShow" ng-click="" style="margin-top:22px;margin-right:3%;">X</a> -->
				...
				<div class="actions">
			<input type="button"  style="display:none" id="copyFromLastWeek" class="btn btn-warning" ng-click="confirmCopy()"
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index:10000">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
        <button type="button" class="btn btn-primary" ng-click="confirmDelete1()">Yes</button>
      </div>
    </div>
  </div>
</div>
