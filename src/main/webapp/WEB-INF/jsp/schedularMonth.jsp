		...
		<section class="w100p">
			<table class="cal-table">
				...
				<tr>
					...
					<td class="current" id="day0" ng-if="monthVM.days[0].assigned"><em>{{monthVM.days[0].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[0].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[0].isHoliday"
					...
					<td class="current" id="day1" ng-if="monthVM.days[1].assigned"><em>{{monthVM.days[1].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[1].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[1].isHoliday"
					...
					<td class="current" id="day2" ng-class="monthVM.days[1].appoinmentCount==2?'current full':monthVM.days[1].appoinmentCount==1?'current almost':'current'" ng-if="monthVM.days[2].assigned"><em>{{monthVM.days[2].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[2].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[2].isHoliday"
					...
					<td class="current" id="day3" ng-if="monthVM.days[3].assigned"><em>{{monthVM.days[3].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[3].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[3].isHoliday"
					...
					<td class="current" id="day4" ng-if="monthVM.days[4].assigned"><em>{{monthVM.days[4].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[4].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[4].isHoliday"
					...
					<td class="current" id="day5" ng-if="monthVM.days[5].assigned"><em>{{monthVM.days[5].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[5].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[5].isHoliday"
					...
					<td class="current" id="day6" ng-if="monthVM.days[6].assigned"><em>{{monthVM.days[6].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[6].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[6].isHoliday"
				...
				<tr>
					...
					<td class="current" id="day7" ng-if="monthVM.days[7].assigned"><em>{{monthVM.days[7].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[7].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[7].isHoliday"
					...
					<td class="current" id="day8" ng-if="monthVM.days[8].assigned"><em>{{monthVM.days[8].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[8].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[8].isHoliday"
					...
					<td class="current" id="day9" ng-if="monthVM.days[9].assigned"><em>{{monthVM.days[9].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[9].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[9].isHoliday"
					...
					<td class="current" id="day10" ng-if="monthVM.days[10].assigned"><em>{{monthVM.days[10].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[10].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a><span ng-hide="monthVM.days[10].isHoliday" 
					...
					<td class="current" id="day11" ng-if="monthVM.days[11].assigned"><em>{{monthVM.days[11].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[11].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[11].isHoliday"
					...
					<td class="current" id="day12" ng-if="monthVM.days[12].assigned"><em>{{monthVM.days[12].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[12].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[12].isHoliday"
					...
					<td class="current" id="day13" ng-if="monthVM.days[13].assigned"><em>{{monthVM.days[13].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[13].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[13].isHoliday"
				...
				<tr>
					...
					<td class="current" id="day14" ng-if="monthVM.days[14].assigned"><em>{{monthVM.days[14].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[14].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[14].isHoliday"
					...
					<td class="current" id="day15" ng-if="monthVM.days[15].assigned"><em>{{monthVM.days[15].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[15].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[15].isHoliday"
					...
					<td class="current" id="day16" ng-if="monthVM.days[16].assigned"><em>{{monthVM.days[16].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[16].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[16].isHoliday"
					...
					<td class="current" id="day17" ng-if="monthVM.days[17].assigned"><em>{{monthVM.days[17].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[17].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[17].isHoliday"
					...
					<td class="current" id="day18" ng-if="monthVM.days[18].assigned"><em>{{monthVM.days[18].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[18].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[18].isHoliday"
					...
					<td class="current" id="day19" ng-if="monthVM.days[19].assigned"><em>{{monthVM.days[19].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[19].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[19].isHoliday"
					...
					<td class="current" id="day20" ng-if="monthVM.days[20].assigned"><em>{{monthVM.days[20].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[20].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[20].isHoliday"
				...
				<tr>
					...
					<td class="current" id="day21" ng-if="monthVM.days[21].assigned"><em>{{monthVM.days[21].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[21].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[21].isHoliday"
					...
					<td class="current" id="day22" ng-if="monthVM.days[22].assigned"><em>{{monthVM.days[22].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[22].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[22].isHoliday"
					...
					<td class="current" id="day23" ng-if="monthVM.days[23].assigned"><em>{{monthVM.days[23].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[23].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[23].isHoliday"
					...
					<td class="current" id="day24" ng-if="monthVM.days[24].assigned"><em>{{monthVM.days[24].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[24].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[24].isHoliday"
					...
					<td class="current" id="day25" ng-if="monthVM.days[25].assigned"><em>{{monthVM.days[25].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[25].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[25].isHoliday"
					...
					<td class="current" id="day26" ng-if="monthVM.days[26].assigned"><em>{{monthVM.days[26].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[26].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[26].isHoliday"
					...
					<td class="current" id="day27" ng-if="monthVM.days[27].assigned"><em>{{monthVM.days[27].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[27].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[27].isHoliday"
				...
				<tr ng-if="monthVM.days[28].assigned">
					...
					<td class="current" id="day28" ng-if="monthVM.days[28].assigned"><em>{{monthVM.days[28].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[28].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[28].isHoliday"
					...
					<td class="current" id="day29" ng-if="monthVM.days[29].assigned"><em>{{monthVM.days[29].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[29].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[29].isHoliday"
					...
					<td class="current" id="day30" ng-if="monthVM.days[30].assigned"><em>{{monthVM.days[30].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[30].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[30].isHoliday"
					...
					<td class="current" id="day31" ng-if="monthVM.days[31].assigned"><em>{{monthVM.days[31].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[31].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[31].isHoliday"
					...
					<td class="current" id="day32" ng-if="monthVM.days[32].assigned"><em>{{monthVM.days[32].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[32].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[32].isHoliday"
					...
					<td class="current" id="day33" ng-if="monthVM.days[33].assigned"><em>{{monthVM.days[33].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[33].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[33].isHoliday"
					...
					<td class="current" id="day34" ng-if="monthVM.days[34].assigned"><em>{{monthVM.days[34].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[34].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[34].isHoliday"
				...
				<tr ng-if="monthVM.days[35].assigned">
					...
					<td class="current" id="day35" ng-if="monthVM.days[35].assigned"><em>{{monthVM.days[35].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[35].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[35].isHoliday"
					...
					<td class="current" id="day36" ng-if="monthVM.days[36].assigned"><em>{{monthVM.days[36].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[36].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[36].isHoliday"
					...
					<td class="current" id="day37" ng-if="monthVM.days[37].assigned"><em>{{monthVM.days[37].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[37].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[37].isHoliday"
					...
					<td class="current" id="day38" ng-if="monthVM.days[38].assigned"><em>{{monthVM.days[38].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[38].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[38].isHoliday"
					...
					<td class="current" id="day39" ng-if="monthVM.days[39].assigned"><em>{{monthVM.days[39].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[39].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[39].isHoliday"
					...
					<td class="current" id="day40" ng-if="monthVM.days[40].assigned"><em>{{monthVM.days[40].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[40].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[40].isHoliday"
					...
					<td class="current" id="day41" ng-if="monthVM.days[41].assigned"><em>{{monthVM.days[41].day}}</em><a
						ng-href="${pageContext.request.contextPath}/{{(monthVM.monthIndex+1)}}-{{monthVM.days[41].day}}-{{monthVM.year}}/{{userId}}" class="bookapp tip"
						title="Day View"></a> <span ng-hide="monthVM.days[41].isHoliday"
