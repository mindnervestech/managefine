...
<div class="tab-content" style="max-height: 437px;">
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			<li><a data-toggle="tab" href="#home"
				style="background-color: rgb(136, 136, 136);">General</a></li>
			<li><a data-toggle="tab" href="#menu1"
				style="background-color: rgb(136, 136, 136);">Project</a></li>
			<li><a data-toggle="tab" href="#menu2"
				style="background-color: rgb(136, 136, 136);">Menu 2</a></li>
			<li><a data-toggle="tab" href="#menu3"
				style="background-color: rgb(136, 136, 136);">Menu 3</a></li>
		</ul>

		<div class="tab-content">
			<div id="home" class="tab-pane fade">
				<ul class="nav nav-tabs" style="background-color: rgb(136, 136, 136);">
    ...
    padding: 0px"
		>
						...
						<label class="control-label" for="textinput">Type of
							Company(Pvt Ltd,LLC,Public Ltd,Govt Enterprise, Semi Govt) </label>
						<div class="controls">
    ...
    padding: 0px"
		>
						...
						<label class="control-label" for="textinput">Office
							Address </label>
						<div class="controls">
    ...
    padding: 0px"
		>
						...
						<label class="control-label" for="textinput">Land line Nos
							of Office </label>
						<div class="controls">
    ...
    padding: 0px"
		>
						...
						<label class="control-label" for="textinput">Factory
							Address </label>
						<div class="controls">
    ...
    padding: 0px"
		>
						...
						<label class="control-label" for="textinput">Production
							Head Name</label>
						<div class="controls">
...
<div class="col-md-12">
			...
			<div id="menu1" class="tab-pane fade" heading="">
				<h6>shfkjsd</h6>
			</div>
