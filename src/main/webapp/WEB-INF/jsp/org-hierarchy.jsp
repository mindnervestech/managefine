...
<script type="text/javascript" src='<c:url value="/resources/customScripts/orgController/app.js"/>'></script>
<script type="text/javascript" src='<c:url value="/resources/customScripts/orgController/controller.js"/>'></script>
