<div class="modal" id="myModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background: blue;color: white;margin: 2px;height: 38px;padding: 2px;border-bottom: 4px gray;">
				...
				<div class="modal-body">
					<div class="form-group">
						<label for="org-name">Role name</label> <input type="text"
							class="form-control col-md-5" ng-model="org.roleName"
					...
					<div class="form-group">
						...
						<select class="col-md-5 required" id="projectTypeId" name="department" data-ng-model="org.department" ng-change="onProjectTypeChange(projectType.projectTypeId)"  placeholder="Select Project type.">  
								<option value="">-select-</option>
								<option ng-repeat="departmentFind in findDepartment" value="{{departmentFind.id}}">{{departmentFind.name}}</option>
					        </select>
					...
					<div class="form-group">
						...
						<textarea  class="form-control col-md-5" ng-model="org.roleDescription" rows="3"
