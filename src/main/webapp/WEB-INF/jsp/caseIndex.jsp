...
<h4><b style=" width: 1051px; margin-left: 20px;"><i>Assigned By Me</i></b></h4>
        ...
        <div>
                    ...
                    <div class="form-group">
                        <label class="col-md-11">Status</label>
                            ...
                            <select class="col-md-5 required" style="margin-left: 14px;" id="caseStatus" name="caseStatus"  ng-model="caseData.caseStatus"  placeholder="Select Project type."  required> 
                    ...
                    <hr style="width: 100%;float: left;">
					 ...
					 <div class="col-md-11">
							 ...
							 <textarea  class="form-control col-md-11" name="caseNote" ng-model="caseData.comment" rows="1"
						 placeholder="Comment." style="margin-bottom: 7px;" required></textarea>
						...
						<div class="col-md-3">
						 <button type="submit" ng-click="saveCaseInfo()" class="btn btn-primary col-md-6" >Save</button> 
						</div>
		    	...
		    	<div class="form-group"  ng-repeat="note in comment">
					 <div class="col-md-11" style="margin-bottom: 17px;">
						 <span style="font-style: italic;font-size: 13px;"> {{note.userName}}  <span style="font-size: 10px;">{{note.commetDate}}</span></span>	
							
						<div class="comment_box  col-md-11">
     							 <p class="comment_paragraph" contenteditable="true"> {{note.caseComment}} </p>
                ...
                <!-- <button type="submit" ng-click="saveCaseInfo()" class="btn btn-primary col-md-3" >Save</button>  -->  <!-- ng-click="addProjectName(projectinfo)" -->
                </div>
                </form>
                </div>    
    </div>
...
<script type="text/javascript" src='<c:url value="/resources/customScripts/casesController/controller.js"/>'></script>
