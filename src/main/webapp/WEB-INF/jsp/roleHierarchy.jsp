...
<div ng-app="RoleApp" ng-controller="RoleController" ng-init='loadData(${data})'>
...
<script type="text/javascript" src='<c:url value="/resources/customScripts/roleController/controller.js"/>'></script>
