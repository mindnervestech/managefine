...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	<jsp:include page="menuContext.jsp"/> 
		<h4><b style=" width: 1051px; margin-left: 20px;"><i>Calendars Bucket</i></b></h4>
...
<script type="text/javascript">
	...
	function My_TimeSheet_Approval_Bucket_confimationDialog(_url)
	 {
		 if(_url == '${pageContext.request.contextPath}/calendar/approveTimesheets'){
			 return false;
		 }
		 
		 if(_url == '${pageContext.request.contextPath}/calendar/rejectTimesheets'){
			 return true;
		 }
		 return false;
