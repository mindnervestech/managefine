...
<head>
  ...
  <link rel=stylesheet href='<c:url value="/resources/angular-widget/app/grantt/platform.css"/>'>
  <link rel=stylesheet href='<c:url value="/resources/angular-widget/app/grantt/libs/dateField/jquery.dateField.css"/>'>

  <link rel=stylesheet href='<c:url value="/resources/angular-widget/app/grantt/gantt.css"/>'>	
  <link rel=stylesheet media="print" href='<c:url value="/resources/angular-widget/app/grantt/ganttPrint.css"/>'>

  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js"></script>
  <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script> 

  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/jquery.livequery.min.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/jquery.timers.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/platform.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/date.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/i18nJs.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/dateField/jquery.dateField.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/JST/jquery.JST.js"/>'></script>

  <link rel=stylesheet href='<c:url value="/resources/angular-widget/app/grantt/libs/jquery.svg.css"/>'>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/jquery.svg.min.js"/>'></script>

  <!--In case of jquery 1.7-->
  <!--<script type="text/javascript" src="libs/jquery.svgdom.pack.js"></script>-->

  <!--In case of jquery 1.8-->
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/libs/jquery.svgdom.1.8.js"/>'></script>

  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/ganttUtilities.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/ganttTask.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/ganttDrawerSVG.js"/>'></script>
  <!--<script src="ganttDrawer.js"></script>-->
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/ganttGridEditor.js"/>'></script>
  <script type="text/javascript" src='<c:url value="/resources/angular-widget/app/grantt/ganttMaster.js"/>'></script>
</head>
