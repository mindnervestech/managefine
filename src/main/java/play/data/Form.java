...
public class Form<T> {
     ...
     */
    public Form<T> bindFromRequest(HttpServletRequest request, String... allowedFields) {
    	Map<java.lang.String,java.lang.String[]> requestData = (Map<java.lang.String,java.lang.String[]>)request.getParameterMap();
    	 Map<String, String> data = requestData(requestData);
	...
	protected Map<String, String> requestData(Map<String, String[]> requestData) {
